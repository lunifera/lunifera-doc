...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Else If Condition</b></em>'. <!-- end-user-doc
 * -->
 * 
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.lunifera.doc.dsl.doccompiler.ElseIfCondition#getRichStringElseIf <em>Rich String Else If</em>}</li>
 * <li>{@link org.lunifera.doc.dsl.doccompiler.ElseIfCondition#getIfConditionStart <em>If Condition Start</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.lunifera.doc.dsl.doccompiler.DocCompilerPackage#getElseIfCondition()
 * @model
 * @generated
 */
public interface ElseIfCondition extends LinePart {
	...
	/**
	 * Returns the value of the '<em><b>If Condition Start</b></em>' reference. It is bidirectional and its opposite is
	 ...
	 * @see org.lunifera.doc.dsl.doccompiler.DocCompilerPackage#getElseIfCondition_IfConditionStart()
