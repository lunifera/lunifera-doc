...
public class URLStartImpl extends LinePartImpl implements URLStart {
		...
		if (content != null && content.eIsProxy()) {
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.URL_START__CONTENT,
							oldContent, content));
			}
		}
		return content;
	...
	public void setContent(RichStringURL newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.URL_START__CONTENT, oldContent,
					content));
	}
	...
	public URLEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.URL_START__END,
							oldEnd, end));
			}
		}
		return end;
	...
	public NotificationChain basicSetEnd(URLEnd newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.URL_START__END, oldEnd, newEnd);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setEnd(URLEnd newEnd) {
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end).eInverseRemove(this, DocCompilerPackage.URL_END__START, URLEnd.class,
						msgs);
			if (newEnd != null)
				msgs = ((InternalEObject) newEnd).eInverseAdd(this, DocCompilerPackage.URL_END__START, URLEnd.class,
						msgs);
