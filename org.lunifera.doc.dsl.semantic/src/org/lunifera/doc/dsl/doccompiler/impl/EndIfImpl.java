...
public class EndIfImpl extends LinePartImpl implements EndIf {
	...
	protected EClass eStaticClass() {
		return DocCompilerPackage.Literals.END_IF;
	}
			...
			if (ifConditionStart != oldIfConditionStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.END_IF__IF_CONDITION_START, oldIfConditionStart, ifConditionStart));
			}
		}
	...
	public void setIfConditionStart(IfConditionStart newIfConditionStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.END_IF__IF_CONDITION_START,
