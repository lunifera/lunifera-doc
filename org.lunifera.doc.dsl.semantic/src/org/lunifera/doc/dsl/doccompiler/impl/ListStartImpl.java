...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>List Start</b></em>'. <!-- end-user-doc -->
 * <p>
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.LIST_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public EList<ListElementStart> getElements() {
		if (elements == null) {
			elements = new EObjectResolvingEList<ListElementStart>(ListElementStart.class, this,
					DocCompilerPackage.LIST_START__ELEMENTS);
		}
		return elements;
	}
	...
	public ListEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.LIST_START__END, oldEnd, end));
			}
		}
		return end;
	}
