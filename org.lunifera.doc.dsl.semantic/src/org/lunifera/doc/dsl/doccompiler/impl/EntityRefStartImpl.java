...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Entity Ref Start</b></em>'. <!-- end-user-doc
 * -->
 * <p>
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.ENTITY_REF_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public EntityRefEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.ENTITY_REF_START__END, oldEnd, end));
			}
		}
		return end;
	}
	...
	public NotificationChain basicSetEnd(EntityRefEnd newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.ENTITY_REF_START__END, oldEnd, newEnd);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end).eInverseRemove(this,
						DocCompilerPackage.ENTITY_REF_END__START, EntityRefEnd.class, msgs);
			if (newEnd != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.ENTITY_REF_START__END, newEnd, newEnd));
	}
