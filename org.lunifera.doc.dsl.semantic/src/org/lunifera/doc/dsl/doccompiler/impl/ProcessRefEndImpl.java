...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Process Ref End</b></em>'. <!-- end-user-doc
 * -->
 * <p>
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.PROCESS_REF_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public NotificationChain basicSetStart(ProcessRefStart newStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.PROCESS_REF_END__START, oldStart, newStart);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject) start).eInverseRemove(this,
						DocCompilerPackage.PROCESS_REF_START__END, ProcessRefStart.class, msgs);
			if (newStart != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.PROCESS_REF_END__START, newStart, newStart));
	}
