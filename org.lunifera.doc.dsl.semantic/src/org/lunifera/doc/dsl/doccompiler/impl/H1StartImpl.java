...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>H1 Start</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class H1StartImpl extends LinePartImpl implements H1Start {
		...
		if (content != null && content.eIsProxy()) {
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.H1_START__CONTENT,
							oldContent, content));
			}
		}
		return content;
	...
	public void setContent(RichStringH1 newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.H1_START__CONTENT, oldContent,
					content));
	}
	...
	public H1End getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.H1_START__END, oldEnd,
							end));
			}
		}
		return end;
	...
	public NotificationChain basicSetEnd(H1End newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.H1_START__END, oldEnd, newEnd);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end)
						.eInverseRemove(this, DocCompilerPackage.H1_END__START, H1End.class, msgs);
			if (newEnd != null)
				msgs = ((InternalEObject) newEnd)
						.eInverseAdd(this, DocCompilerPackage.H1_END__START, H1End.class, msgs);
