...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Ordered List Start</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class OrderedListStartImpl extends LinePartImpl implements OrderedListStart {
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.ORDERED_LIST_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public EList<ListElementStart> getElements() {
		if (elements == null) {
			elements = new EObjectResolvingEList<ListElementStart>(ListElementStart.class, this,
					DocCompilerPackage.ORDERED_LIST_START__ELEMENTS);
		}
		return elements;
	}
	...
	public OrderedListEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.ORDERED_LIST_START__END, oldEnd, end));
			}
		}
		return end;
	}
