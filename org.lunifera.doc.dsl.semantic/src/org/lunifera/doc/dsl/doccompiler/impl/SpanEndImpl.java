...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Span End</b></em>'. <!-- end-user-doc -->
 * <p>
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.SPAN_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public NotificationChain basicSetStart(SpanStart newStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.SPAN_END__START, oldStart, newStart);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject) start).eInverseRemove(this,
						DocCompilerPackage.SPAN_START__END, SpanStart.class, msgs);
			if (newStart != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.SPAN_END__START, newStart, newStart));
	}
