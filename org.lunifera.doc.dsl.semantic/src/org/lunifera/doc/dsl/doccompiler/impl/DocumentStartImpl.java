...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Document Start</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class DocumentStartImpl extends LinePartImpl implements DocumentStart {
	...
	/**
	 * The cached value of the '{@link #getDocument() <em>Document</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getDocument()
	 * @generated
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.DOCUMENT_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public void setContent(ProcessedRichString newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.DOCUMENT_START__CONTENT,
					oldContent, content));
	}
	...
	public DocumentEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.DOCUMENT_START__END,
							oldEnd, end));
			}
		}
		return end;
	...
	public NotificationChain basicSetEnd(DocumentEnd newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.DOCUMENT_START__END, oldEnd, newEnd);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setEnd(DocumentEnd newEnd) {
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end).eInverseRemove(this, DocCompilerPackage.DOCUMENT_END__START,
						DocumentEnd.class, msgs);
			if (newEnd != null)
				msgs = ((InternalEObject) newEnd).eInverseAdd(this, DocCompilerPackage.DOCUMENT_END__START,
						DocumentEnd.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.DOCUMENT_START__END, newEnd,
					newEnd));
	}
	...
	public NamedDocument getDocument() {
		if (document != null && document.eIsProxy()) {
			...
			if (document != oldDocument) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.DOCUMENT_START__DOCUMENT, oldDocument, document));
			}
		}
		return document;
	}
	...
	public void setDocument(NamedDocument newDocument) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.DOCUMENT_START__DOCUMENT,
