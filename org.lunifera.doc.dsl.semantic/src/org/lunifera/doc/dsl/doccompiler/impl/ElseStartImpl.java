...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Else Start</b></em>'. <!-- end-user-doc -->
 * <p>
			...
			if (ifConditionStart != oldIfConditionStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.ELSE_START__IF_CONDITION_START, oldIfConditionStart, ifConditionStart));
			}
		}
	...
	public NotificationChain basicSetIfConditionStart(IfConditionStart newIfConditionStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.ELSE_START__IF_CONDITION_START, oldIfConditionStart, newIfConditionStart);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newIfConditionStart != ifConditionStart) {
			...
			if (ifConditionStart != null)
				msgs = ((InternalEObject) ifConditionStart).eInverseRemove(this,
						DocCompilerPackage.IF_CONDITION_START__ELSE_START, IfConditionStart.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.ELSE_START__IF_CONDITION_START,
					newIfConditionStart, newIfConditionStart));
	}
