...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Table Start</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class TableStartImpl extends LinePartImpl implements TableStart {
	...
	public EList<RichStringTableRow> getRows() {
		if (rows == null) {
			rows = new EObjectResolvingEList<RichStringTableRow>(RichStringTableRow.class, this,
					DocCompilerPackage.TABLE_START__ROWS);
		}
		return rows;
	}
	...
	public TableEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.TABLE_START__END, oldEnd, end));
			}
		}
		return end;
	}
