...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Processed Rich String</b></em>'. <!--
 * end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class ProcessedRichStringImpl extends MinimalEObjectImpl.Container implements
		ProcessedRichString {
	/**
	...
	protected EClass eStaticClass() {
		return DocCompilerPackage.Literals.PROCESSED_RICH_STRING;
	}
			...
			if (richString != oldRichString) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.PROCESSED_RICH_STRING__RICH_STRING, oldRichString,
							richString));
			}
		}
		return richString;
	...
	public EList<Line> getLines() {
		if (lines == null) {
			lines = new EObjectContainmentWithInverseEList<Line>(Line.class, this,
					DocCompilerPackage.PROCESSED_RICH_STRING__LINES,
					DocCompilerPackage.LINE__RICH_STRING);
		}
		return lines;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		case DocCompilerPackage.PROCESSED_RICH_STRING__LINES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getLines()).basicAdd(
					otherEnd, msgs);
		}
