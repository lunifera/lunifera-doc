...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>View Ref End</b></em>'. <!-- end-user-doc -->
 * <p>
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.VIEW_REF_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public NotificationChain basicSetStart(ViewRefStart newStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.VIEW_REF_END__START, oldStart, newStart);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject) start).eInverseRemove(this,
						DocCompilerPackage.VIEW_REF_START__END, ViewRefStart.class, msgs);
			if (newStart != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.VIEW_REF_END__START, newStart, newStart));
	}
