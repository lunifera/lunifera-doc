...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>H5 Start</b></em>'. <!-- end-user-doc -->
 * <p>
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.H5_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public H5End getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.H5_START__END, oldEnd, end));
			}
		}
		return end;
	}
	...
	public NotificationChain basicSetEnd(H5End newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.H5_START__END, oldEnd, newEnd);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end).eInverseRemove(this,
						DocCompilerPackage.H5_END__START, H5End.class, msgs);
			if (newEnd != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.H5_START__END,
					newEnd, newEnd));
	}
