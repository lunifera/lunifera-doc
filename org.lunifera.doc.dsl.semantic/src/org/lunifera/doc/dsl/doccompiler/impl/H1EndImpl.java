...
public class H1EndImpl extends LinePartImpl implements H1End {
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.H1_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public NotificationChain basicSetStart(H1Start newStart, NotificationChain msgs) {
		...
		start = newStart;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocCompilerPackage.H1_END__START, oldStart, newStart);
	...
	public void setStart(H1Start newStart) {
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject)start).eInverseRemove(this, DocCompilerPackage.H1_START__END, H1Start.class, msgs);
			if (newStart != null)
				msgs = ((InternalEObject)newStart).eInverseAdd(this, DocCompilerPackage.H1_START__END, H1Start.class, msgs);
