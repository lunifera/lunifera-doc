 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.doccompiler.impl.ListElementEndImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ListElementEndImpl extends LinePartImpl implements ListElementEnd {
	...
	protected EClass eStaticClass() {
		return DocCompilerPackage.Literals.LIST_ELEMENT_END;
	}
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.LIST_ELEMENT_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public void setStart(ListElementStart newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.LIST_ELEMENT_END__START, oldStart, start));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DocCompilerPackage.LIST_ELEMENT_END__START:
