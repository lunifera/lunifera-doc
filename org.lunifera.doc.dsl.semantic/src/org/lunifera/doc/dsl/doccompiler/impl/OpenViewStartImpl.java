...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Open View Start</b></em>'. <!-- end-user-doc
 * -->
 * <p>
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.OPEN_VIEW_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public OpenViewEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.OPEN_VIEW_START__END, oldEnd, end));
			}
		}
		return end;
	}
	...
	public NotificationChain basicSetEnd(OpenViewEnd newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.OPEN_VIEW_START__END, oldEnd, newEnd);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end).eInverseRemove(this,
						DocCompilerPackage.OPEN_VIEW_END__START, OpenViewEnd.class, msgs);
			if (newEnd != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.OPEN_VIEW_START__END, newEnd, newEnd));
	}
