...
public class TableRowEndImpl extends LinePartImpl implements TableRowEnd {
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.TABLE_ROW_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public void setStart(TableRowStart newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.TABLE_ROW_END__START, oldStart, start));
	}
