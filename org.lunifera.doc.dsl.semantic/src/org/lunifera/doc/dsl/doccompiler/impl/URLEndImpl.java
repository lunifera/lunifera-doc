...
public class URLEndImpl extends LinePartImpl implements URLEnd {
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.URL_END__START,
							oldStart, start));
			}
		}
		return start;
	...
	public NotificationChain basicSetStart(URLStart newStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.URL_END__START, oldStart, newStart);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setStart(URLStart newStart) {
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject) start).eInverseRemove(this, DocCompilerPackage.URL_START__END,
						URLStart.class, msgs);
			if (newStart != null)
				msgs = ((InternalEObject) newStart).eInverseAdd(this, DocCompilerPackage.URL_START__END,
						URLStart.class, msgs);
