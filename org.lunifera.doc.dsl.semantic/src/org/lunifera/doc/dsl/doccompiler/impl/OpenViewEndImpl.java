...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Open View End</b></em>'. <!-- end-user-doc -->
 * <p>
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.OPEN_VIEW_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public NotificationChain basicSetStart(OpenViewStart newStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.OPEN_VIEW_END__START, oldStart, newStart);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject) start).eInverseRemove(this,
						DocCompilerPackage.OPEN_VIEW_START__END, OpenViewStart.class, msgs);
			if (newStart != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.OPEN_VIEW_END__START, newStart, newStart));
	}
