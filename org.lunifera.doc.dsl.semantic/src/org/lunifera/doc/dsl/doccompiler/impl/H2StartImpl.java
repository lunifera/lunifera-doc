			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.H2_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public H2End getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.H2_START__END, oldEnd, end));
			}
		}
		return end;
	}
		...
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end).eInverseRemove(this,
						DocCompilerPackage.H2_END__START, H2End.class, msgs);
			if (newEnd != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.H2_START__END,
					newEnd, newEnd));
	}
