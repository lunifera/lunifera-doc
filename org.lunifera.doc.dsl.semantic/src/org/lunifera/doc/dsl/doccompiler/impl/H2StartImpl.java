...
public class H2StartImpl extends LinePartImpl implements H2Start {
		...
		if (content != null && content.eIsProxy()) {
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.H2_START__CONTENT,
							oldContent, content));
			}
		}
		return content;
	...
	public void setContent(RichStringH2 newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.H2_START__CONTENT, oldContent,
					content));
	}
	...
	public H2End getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.H2_START__END, oldEnd,
							end));
			}
		}
		return end;
	...
	public NotificationChain basicSetEnd(H2End newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.H2_START__END, oldEnd, newEnd);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end)
						.eInverseRemove(this, DocCompilerPackage.H2_END__START, H2End.class, msgs);
			if (newEnd != null)
				msgs = ((InternalEObject) newEnd)
						.eInverseAdd(this, DocCompilerPackage.H2_END__START, H2End.class, msgs);
