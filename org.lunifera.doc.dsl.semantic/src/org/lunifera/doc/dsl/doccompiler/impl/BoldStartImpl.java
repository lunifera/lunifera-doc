...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Bold Start</b></em>'. <!-- end-user-doc -->
 * <p>
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.BOLD_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public BoldEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.BOLD_START__END, oldEnd, end));
			}
		}
		return end;
	}
