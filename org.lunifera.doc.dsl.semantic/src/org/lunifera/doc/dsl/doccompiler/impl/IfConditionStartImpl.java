...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>If Condition Start</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 ...
 * <li>{@link org.lunifera.doc.dsl.doccompiler.impl.IfConditionStartImpl#getElseIfConditions <em>Else If Conditions
 * </em>}</li>
...
public class IfConditionStartImpl extends LinePartImpl implements IfConditionStart {
	/**
	 * The cached value of the '{@link #getRichStringIf() <em>Rich String If</em>}' reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getRichStringIf()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getElseStart() <em>Else Start</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getElseStart()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getEndIf() <em>End If</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getEndIf()
	 * @generated
			...
			if (richStringIf != oldRichStringIf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.IF_CONDITION_START__RICH_STRING_IF, oldRichStringIf, richStringIf));
			}
		}
		return richStringIf;
	}
	...
	public ElseStart getElseStart() {
		if (elseStart != null && elseStart.eIsProxy()) {
			...
			if (elseStart != oldElseStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.IF_CONDITION_START__ELSE_START, oldElseStart, elseStart));
			}
		}
		return elseStart;
	}
	...
	public NotificationChain basicSetElseStart(ElseStart newElseStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.IF_CONDITION_START__ELSE_START, oldElseStart, newElseStart);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setElseStart(ElseStart newElseStart) {
		if (newElseStart != elseStart) {
			...
			if (elseStart != null)
				msgs = ((InternalEObject) elseStart).eInverseRemove(this,
						DocCompilerPackage.ELSE_START__IF_CONDITION_START, ElseStart.class, msgs);
			if (newElseStart != null)
				msgs = ((InternalEObject) newElseStart).eInverseAdd(this,
						DocCompilerPackage.ELSE_START__IF_CONDITION_START, ElseStart.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.IF_CONDITION_START__ELSE_START,
					newElseStart, newElseStart));
	}
	...
	public EList<ElseIfCondition> getElseIfConditions() {
		if (elseIfConditions == null) {
			elseIfConditions = new EObjectWithInverseResolvingEList<ElseIfCondition>(ElseIfCondition.class, this,
					DocCompilerPackage.IF_CONDITION_START__ELSE_IF_CONDITIONS,
					DocCompilerPackage.ELSE_IF_CONDITION__IF_CONDITION_START);
		}
	...
	public EndIf getEndIf() {
		if (endIf != null && endIf.eIsProxy()) {
			...
			if (endIf != oldEndIf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.IF_CONDITION_START__END_IF, oldEndIf, endIf));
			}
		}
		return endIf;
	}
	...
	public void setEndIf(EndIf newEndIf) {
		...
		endIf = newEndIf;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.IF_CONDITION_START__END_IF,
					oldEndIf, endIf));
	}
