...
public class IfConditionStartImpl extends LinePartImpl implements IfConditionStart {
			...
			if (richStringIf != oldRichStringIf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.IF_CONDITION_START__RICH_STRING_IF, oldRichStringIf,
							richStringIf));
			}
		}
		return richStringIf;
	...
	public ElseStart getElseStart() {
		if (elseStart != null && elseStart.eIsProxy()) {
			...
			if (elseStart != oldElseStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.IF_CONDITION_START__ELSE_START, oldElseStart,
							elseStart));
			}
		}
		return elseStart;
	...
	public void setElseStart(ElseStart newElseStart) {
		if (newElseStart != elseStart) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.IF_CONDITION_START__ELSE_START, newElseStart, newElseStart));
	}
	...
	public EList<ElseIfCondition> getElseIfConditions() {
		if (elseIfConditions == null) {
			elseIfConditions = new EObjectWithInverseResolvingEList<ElseIfCondition>(
					ElseIfCondition.class, this,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		case DocCompilerPackage.IF_CONDITION_START__ELSE_IF_CONDITIONS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getElseIfConditions())
