			...
			if (loop != oldLoop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.FOR_LOOP_START__LOOP, oldLoop, loop));
			}
		}
		return loop;
	}
	...
	public ForLoopEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.FOR_LOOP_START__END, oldEnd, end));
			}
		}
		return end;
	}
		...
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end).eInverseRemove(this,
						DocCompilerPackage.FOR_LOOP_END__START, ForLoopEnd.class, msgs);
			if (newEnd != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.FOR_LOOP_START__END, newEnd, newEnd));
	}
