...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>For Loop Start</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class ForLoopStartImpl extends LinePartImpl implements ForLoopStart {
	/**
	 * The cached value of the '{@link #getLoop() <em>Loop</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @see #getLoop()
	 * @generated
		...
		if (loop != null && loop.eIsProxy()) {
			...
			if (loop != oldLoop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.FOR_LOOP_START__LOOP,
							oldLoop, loop));
			}
		}
		return loop;
	...
	public void setLoop(RichStringForLoop newLoop) {
		...
		loop = newLoop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.FOR_LOOP_START__LOOP, oldLoop,
					loop));
	}
	...
	public ForLoopEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.FOR_LOOP_START__END,
							oldEnd, end));
			}
		}
		return end;
	...
	public NotificationChain basicSetEnd(ForLoopEnd newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.FOR_LOOP_START__END, oldEnd, newEnd);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setEnd(ForLoopEnd newEnd) {
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end).eInverseRemove(this, DocCompilerPackage.FOR_LOOP_END__START,
						ForLoopEnd.class, msgs);
			if (newEnd != null)
				msgs = ((InternalEObject) newEnd).eInverseAdd(this, DocCompilerPackage.FOR_LOOP_END__START,
						ForLoopEnd.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.FOR_LOOP_START__END, newEnd,
					newEnd));
	}
