...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>H2 End</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class H2EndImpl extends LinePartImpl implements H2End {
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.H2_END__START,
							oldStart, start));
			}
		}
		return start;
	...
	public NotificationChain basicSetStart(H2Start newStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.H2_END__START, oldStart, newStart);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setStart(H2Start newStart) {
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject) start).eInverseRemove(this, DocCompilerPackage.H2_START__END, H2Start.class,
						msgs);
			if (newStart != null)
				msgs = ((InternalEObject) newStart).eInverseAdd(this, DocCompilerPackage.H2_START__END, H2Start.class,
						msgs);
