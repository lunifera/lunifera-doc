...
public class LineImpl extends MinimalEObjectImpl.Container implements Line {
	/**
	 * The cached value of the '{@link #getParts() <em>Parts</em>}' containment reference list. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getParts()
	 * @generated
	...
	public EList<LinePart> getParts() {
		if (parts == null) {
			parts = new EObjectContainmentWithInverseEList<LinePart>(LinePart.class, this,
					DocCompilerPackage.LINE__PARTS, DocCompilerPackage.LINE_PART__LINE);
		}
		return parts;
	}
	...
	public ProcessedRichString getRichString() {
		if (eContainerFeatureID() != DocCompilerPackage.LINE__RICH_STRING)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRichString(ProcessedRichString newRichString,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newRichString,
				DocCompilerPackage.LINE__RICH_STRING, msgs);
		return msgs;
	}
	...
	public void setRichString(ProcessedRichString newRichString) {
		if (newRichString != eInternalContainer()
				|| (eContainerFeatureID() != DocCompilerPackage.LINE__RICH_STRING && newRichString != null)) {
			...
			if (newRichString != null)
				msgs = ((InternalEObject) newRichString).eInverseAdd(this,
						DocCompilerPackage.PROCESSED_RICH_STRING__LINES, ProcessedRichString.class,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocCompilerPackage.LINE__RICH_STRING, newRichString, newRichString));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		case DocCompilerPackage.LINE__PARTS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getParts()).basicAdd(
					otherEnd, msgs);
