...
public class LineImpl extends MinimalEObjectImpl.Container implements Line {
		...
		if (newRichString != eInternalContainer()
			...
			if (newRichString != null)
				msgs = ((InternalEObject) newRichString).eInverseAdd(this,
						DocCompilerPackage.PROCESSED_RICH_STRING__LINES, ProcessedRichString.class, msgs);
			msgs = basicSetRichString(newRichString, msgs);
			if (msgs != null)
				msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.LINE__RICH_STRING, newRichString,
					newRichString));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case DocCompilerPackage.LINE__RICH_STRING:
			return eInternalContainer().eInverseRemove(this, DocCompilerPackage.PROCESSED_RICH_STRING__LINES,
					ProcessedRichString.class, msgs);
		}
