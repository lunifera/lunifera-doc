...
public class UIRefEndImpl extends LinePartImpl implements UIRefEnd {
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DocCompilerPackage.UI_REF_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public NotificationChain basicSetStart(UIRefStart newStart, NotificationChain msgs) {
		...
		start = newStart;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocCompilerPackage.UI_REF_END__START, oldStart, newStart);
	...
	public void setStart(UIRefStart newStart) {
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject)start).eInverseRemove(this, DocCompilerPackage.UI_REF_START__END, UIRefStart.class, msgs);
			if (newStart != null)
				msgs = ((InternalEObject)newStart).eInverseAdd(this, DocCompilerPackage.UI_REF_START__END, UIRefStart.class, msgs);
			msgs = basicSetStart(newStart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocCompilerPackage.UI_REF_END__START, newStart, newStart));
	}
