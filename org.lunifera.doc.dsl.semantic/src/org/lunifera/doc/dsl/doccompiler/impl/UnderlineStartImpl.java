...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Underline Start</b></em>'. <!-- end-user-doc
 * -->
 * <p>
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.UNDERLINE_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public UnderlineEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DocCompilerPackage.UNDERLINE_START__END, oldEnd, end));
			}
		}
		return end;
	}
