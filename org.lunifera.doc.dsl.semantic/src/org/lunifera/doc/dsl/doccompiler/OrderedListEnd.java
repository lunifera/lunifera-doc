...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Ordered List End</b></em>'. <!-- end-user-doc
 * -->
 * 
 * <p>
...
public interface OrderedListEnd extends LinePart {
	...
	/**
	 * Sets the value of the '{@link org.lunifera.doc.dsl.doccompiler.OrderedListEnd#getStart <em>Start</em>}'
