...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>For Loop Start</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface ForLoopStart extends LinePart {
	/**
	 * Returns the value of the '<em><b>Loop</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Loop</em>' reference isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Loop</em>' reference.
	 * @see #getLoop()
	 * @generated
	 */
	 ...
	 * {@link org.lunifera.doc.dsl.doccompiler.ForLoopEnd#getStart <em>Start</em>}'. <!-- begin-user-doc -->
	 * <p>
