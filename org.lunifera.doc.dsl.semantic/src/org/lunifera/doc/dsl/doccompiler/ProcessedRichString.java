...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Processed Rich String</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface ProcessedRichString extends EObject {
	/**
	 * Returns the value of the '<em><b>Rich String</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Rich String</em>' reference isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.lunifera.doc.dsl.doccompiler.ProcessedRichString#getRichString
	 * <em>Rich String</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Rich String</em>' reference.
	 * @see #getRichString()
	 * @generated
	 */
	 ...
	 * {@link org.lunifera.doc.dsl.doccompiler.Line}. It is bidirectional and its opposite is '
	 * {@link org.lunifera.doc.dsl.doccompiler.Line#getRichString <em>Rich String</em>}'. <!-- begin-user-doc -->
	 * <p>
