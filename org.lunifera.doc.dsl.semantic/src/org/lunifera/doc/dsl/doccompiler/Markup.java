...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Markup</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface Markup extends LinePart {
	/**
	 * Returns the value of the '<em><b>Markup</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Markup</em>' reference isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Markup</em>' reference.
	 * @see #getMarkup()
	 * @generated
	 */
