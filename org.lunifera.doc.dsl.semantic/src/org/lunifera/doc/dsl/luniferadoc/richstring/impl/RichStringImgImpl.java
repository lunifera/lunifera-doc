...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Rich String Img</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class RichStringImgImpl extends XExpressionImpl implements RichStringImg {
	...
	/**
	 * The default value of the '{@link #getAlt() <em>Alt</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @see #getAlt()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getAlt() <em>Alt</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getAlt()
	 * @generated
	 * @ordered
	...
	protected EClass eStaticClass() {
		return RichstringPackage.Literals.RICH_STRING_IMG;
	}
	...
	public void setSrc(String newSrc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_IMG__SRC, oldSrc, src));
	}
	...
	public void setAlt(String newAlt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_IMG__ALT, oldAlt, alt));
	}
	...
	public void setWidth(String newWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_IMG__WIDTH, oldWidth, width));
	}
	...
	public void setHeight(String newHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_IMG__HEIGHT, oldHeight, height));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RichstringPackage.RICH_STRING_IMG__SRC:
			return getSrc();
		case RichstringPackage.RICH_STRING_IMG__ALT:
			return getAlt();
		case RichstringPackage.RICH_STRING_IMG__WIDTH:
			return getWidth();
		case RichstringPackage.RICH_STRING_IMG__HEIGHT:
			return getHeight();
		}
