...
public class RichStringStartProcessImpl extends RichStringMarkupImpl implements RichStringStartProcess {
	...
	protected EClass eStaticClass() {
		return LunDocRichstringPackage.Literals.RICH_STRING_START_PROCESS;
	}
	...
	public void setProcessId(String newProcessId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocRichstringPackage.RICH_STRING_START_PROCESS__PROCESS_ID, oldProcessId, processId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunDocRichstringPackage.RICH_STRING_START_PROCESS__PROCESS_ID:
				return getProcessId();
		}
