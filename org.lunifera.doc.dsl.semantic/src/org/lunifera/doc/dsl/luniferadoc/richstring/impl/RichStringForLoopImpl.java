...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Rich String For Loop</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class RichStringForLoopImpl extends XForLoopExpressionImpl implements RichStringForLoop {
	/**
	 * The cached value of the '{@link #getBefore() <em>Before</em>}' containment reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getBefore()
	 * @generated
	...
	public NotificationChain basicSetBefore(XExpression newBefore, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_FOR_LOOP__BEFORE, oldBefore, newBefore);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newBefore != before) {
			...
			if (before != null)
				msgs = ((InternalEObject) before).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- RichstringPackage.RICH_STRING_FOR_LOOP__BEFORE, null, msgs);
			if (newBefore != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_FOR_LOOP__BEFORE,
					newBefore, newBefore));
	}
	...
	public NotificationChain basicSetSeparator(XExpression newSeparator, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_FOR_LOOP__SEPARATOR, oldSeparator, newSeparator);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newSeparator != separator) {
			...
			if (separator != null)
				msgs = ((InternalEObject) separator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- RichstringPackage.RICH_STRING_FOR_LOOP__SEPARATOR, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_FOR_LOOP__SEPARATOR,
	...
	public NotificationChain basicSetAfter(XExpression newAfter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_FOR_LOOP__AFTER, oldAfter, newAfter);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newAfter != after) {
			...
			if (after != null)
				msgs = ((InternalEObject) after).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- RichstringPackage.RICH_STRING_FOR_LOOP__AFTER, null, msgs);
			if (newAfter != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_FOR_LOOP__AFTER,
					newAfter, newAfter));
	}
