 ...
 * <ul>
 * <li>{@link org.lunifera.doc.dsl.luniferadoc.richstring.RichStringProcessRef#getRefId <em>Ref Id</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface RichStringProcessRef extends RichStringMarkup {
	 ...
	 * @see #setRefId(String)
	 * @see org.lunifera.doc.dsl.luniferadoc.richstring.RichstringPackage#getRichStringProcessRef_RefId()
	 * @model
	 * @generated
	 */
	String getRefId();
	...
	/**
	 * Sets the value of the '{@link org.lunifera.doc.dsl.luniferadoc.richstring.RichStringProcessRef#getRefId
