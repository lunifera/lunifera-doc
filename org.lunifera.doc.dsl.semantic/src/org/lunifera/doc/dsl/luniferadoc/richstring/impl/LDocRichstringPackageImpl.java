...
import org.lunifera.doc.dsl.luniferadoc.impl.LDocPackageImpl;

import org.lunifera.doc.dsl.luniferadoc.richstring.LDocRichstringFactory;
 ...
 * @generated
 */
public class LDocRichstringPackageImpl extends EPackageImpl implements LDocRichstringPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.lunifera.doc.dsl.luniferadoc.richstring.LDocRichstringPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private LDocRichstringPackageImpl() {
		super(eNS_URI, LDocRichstringFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link LDocRichstringPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static LDocRichstringPackage init() {
		if (isInited) return (LDocRichstringPackage)EPackage.Registry.INSTANCE.getEPackage(LDocRichstringPackage.eNS_URI);

		// Obtain or create and register package
		LDocRichstringPackageImpl theLDocRichstringPackage = (LDocRichstringPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof LDocRichstringPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new LDocRichstringPackageImpl());
		...
		LDocPackageImpl theLDocPackage = (LDocPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(LDocPackage.eNS_URI) instanceof LDocPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(LDocPackage.eNS_URI) : LDocPackage.eINSTANCE);
		...
		theLDocRichstringPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(LDocRichstringPackage.eNS_URI, theLDocRichstringPackage);
		return theLDocRichstringPackage;
	}
	 ...
	 * @generated
	 */
	public LDocRichstringFactory getLDocRichstringFactory() {
		return (LDocRichstringFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRichStringMarkup_Id(), ecorePackage.getEString(), "id", null, 0, 1, RichStringMarkup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRichStringMarkup_StyleClass(), ecorePackage.getEString(), "styleClass", null, 0, 1, RichStringMarkup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRichStringChapter_Name(), ecorePackage.getEString(), "name", null, 1, 1, RichStringChapter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRichStringSection_Name(), ecorePackage.getEString(), "name", null, 1, 1, RichStringSection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRichStringSubsection_Name(), ecorePackage.getEString(), "name", null, 1, 1, RichStringSubsection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRichStringRef_RefId(), ecorePackage.getEString(), "refId", null, 0, 1, RichStringRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRichStringImg_Src(), ecorePackage.getEString(), "src", null, 1, 1, RichStringImg.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRichStringImg_Alt(), ecorePackage.getEString(), "alt", null, 1, 1, RichStringImg.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRichStringImg_Width(), ecorePackage.getEString(), "width", null, 1, 1, RichStringImg.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRichStringImg_Height(), ecorePackage.getEString(), "height", null, 1, 1, RichStringImg.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRichStringMailto_Email(), ecorePackage.getEString(), "email", null, 1, 1, RichStringMailto.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRichStringSkype_Target(), ecorePackage.getEString(), "target", null, 1, 1, RichStringSkype.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRichStringMovie_Src(), ecorePackage.getEString(), "src", null, 1, 1, RichStringMovie.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRichStringMovie_Width(), ecorePackage.getEString(), "width", null, 1, 1, RichStringMovie.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRichStringMovie_Height(), ecorePackage.getEString(), "height", null, 1, 1, RichStringMovie.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRichStringMovie_Type(), ecorePackage.getEString(), "type", null, 1, 1, RichStringMovie.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRichStringCode_Lang(), ecorePackage.getEString(), "lang", null, 0, 1, RichStringCode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRichStringStartProcess_ProcessId(), ecorePackage.getEString(), "processId", null, 0, 1, RichStringStartProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRichStringEntityRef_EntityDoc(), theLDocPackage.getLDocEntityDocument(), null, "entityDoc", null, 0, 1, RichStringEntityRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRichStringDTORef_DtoDoc(), theLDocPackage.getLDocDtoDocument(), null, "dtoDoc", null, 0, 1, RichStringDTORef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRichStringProcessRef_ProcessDoc(), theLDocPackage.getLDocBPMProcessDocument(), null, "processDoc", null, 0, 1, RichStringProcessRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRichStringTaskRef_TaskDoc(), theLDocPackage.getLDocHumanTaskDocument(), null, "taskDoc", null, 0, 1, RichStringTaskRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRichStringViewRef_ViewDoc(), theLDocPackage.getLDocViewDocument(), null, "viewDoc", null, 0, 1, RichStringViewRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
