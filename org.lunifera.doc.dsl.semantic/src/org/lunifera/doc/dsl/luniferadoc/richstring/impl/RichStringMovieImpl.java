...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Rich String Movie</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class RichStringMovieImpl extends XExpressionImpl implements RichStringMovie {
	...
	protected EClass eStaticClass() {
		return RichstringPackage.Literals.RICH_STRING_MOVIE;
	}
	...
	public void setSrc(String newSrc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_MOVIE__SRC, oldSrc, src));
	}
	...
	public void setWidth(String newWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_MOVIE__WIDTH, oldWidth, width));
	}
	...
	public void setHeight(String newHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_MOVIE__HEIGHT, oldHeight, height));
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_MOVIE__TYPE, oldType, type));
	}
	...
	public NotificationChain basicSetContent(XExpression newContent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_MOVIE__CONTENT, oldContent, newContent);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject) content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- RichstringPackage.RICH_STRING_MOVIE__CONTENT, null, msgs);
			if (newContent != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_MOVIE__CONTENT, newContent, newContent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
		case RichstringPackage.RICH_STRING_MOVIE__CONTENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RichstringPackage.RICH_STRING_MOVIE__SRC:
			return getSrc();
		case RichstringPackage.RICH_STRING_MOVIE__WIDTH:
			return getWidth();
		case RichstringPackage.RICH_STRING_MOVIE__HEIGHT:
			return getHeight();
		case RichstringPackage.RICH_STRING_MOVIE__TYPE:
			return getType();
		case RichstringPackage.RICH_STRING_MOVIE__CONTENT:
			return getContent();
		}
