...
public class RichStringIfImpl extends XExpressionImpl implements RichStringIf {
	...
	public void setIf(XExpression newIf) {
		if (newIf != if_) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_IF__IF, newIf, newIf));
	}
	...
	public void setThen(XExpression newThen) {
		if (newThen != then) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_IF__THEN, newThen, newThen));
	}
	...
	public void setElse(XExpression newElse) {
		if (newElse != else_) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_IF__ELSE, newElse, newElse));
	}
