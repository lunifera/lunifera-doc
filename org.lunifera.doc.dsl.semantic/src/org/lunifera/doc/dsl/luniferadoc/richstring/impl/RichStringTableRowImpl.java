...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Rich String Table Row</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.richstring.impl.RichStringTableRowImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.richstring.impl.RichStringTableRowImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RichStringTableRowImpl extends RichStringMarkupImpl implements RichStringTableRow {
	...
	protected EClass eStaticClass() {
		return LDocRichstringPackage.Literals.RICH_STRING_TABLE_ROW;
	}
	...
	public EList<RichStringTableData> getColumns() {
		if (columns == null) {
			columns = new EObjectContainmentEList<RichStringTableData>(RichStringTableData.class, this, LDocRichstringPackage.RICH_STRING_TABLE_ROW__COLUMNS);
		}
		return columns;
	}
	...
	public EList<XExpression> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<XExpression>(XExpression.class, this, LDocRichstringPackage.RICH_STRING_TABLE_ROW__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocRichstringPackage.RICH_STRING_TABLE_ROW__COLUMNS:
				return ((InternalEList<?>)getColumns()).basicRemove(otherEnd, msgs);
			case LDocRichstringPackage.RICH_STRING_TABLE_ROW__EXPRESSIONS:
