...
public class RichStringDTORefImpl extends RichStringMarkupImpl implements RichStringDTORef {
	...
	protected EClass eStaticClass() {
		return LDocRichstringPackage.Literals.RICH_STRING_DTO_REF;
	}
		...
		if (dtoDoc != null && dtoDoc.eIsProxy()) {
			...
			if (dtoDoc != oldDtoDoc) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocRichstringPackage.RICH_STRING_DTO_REF__DTO_DOC, oldDtoDoc, dtoDoc));
			}
		}
		return dtoDoc;
	}
	...
	public void setDtoDoc(LDocDtoDocument newDtoDoc) {
		...
		dtoDoc = newDtoDoc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocRichstringPackage.RICH_STRING_DTO_REF__DTO_DOC, oldDtoDoc, dtoDoc));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocRichstringPackage.RICH_STRING_DTO_REF__DTO_DOC:
