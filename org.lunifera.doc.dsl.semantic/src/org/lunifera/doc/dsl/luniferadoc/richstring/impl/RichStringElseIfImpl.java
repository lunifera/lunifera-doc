...
public class RichStringElseIfImpl extends MinimalEObjectImpl.Container implements RichStringElseIf {
	...
	public NotificationChain basicSetIf(XExpression newIf, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_ELSE_IF__IF, oldIf, newIf);
	...
	public void setIf(XExpression newIf) {
		if (newIf != if_) {
			...
			if (if_ != null)
				msgs = ((InternalEObject)if_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RichstringPackage.RICH_STRING_ELSE_IF__IF, null, msgs);
			if (newIf != null)
				msgs = ((InternalEObject)newIf).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RichstringPackage.RICH_STRING_ELSE_IF__IF, null, msgs);
			msgs = basicSetIf(newIf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_ELSE_IF__IF, newIf, newIf));
	}
	...
	public NotificationChain basicSetThen(XExpression newThen, NotificationChain msgs) {
		...
		then = newThen;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_ELSE_IF__THEN, oldThen, newThen);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setThen(XExpression newThen) {
		if (newThen != then) {
			NotificationChain msgs = null;
			if (then != null)
				msgs = ((InternalEObject)then).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RichstringPackage.RICH_STRING_ELSE_IF__THEN, null, msgs);
			if (newThen != null)
				msgs = ((InternalEObject)newThen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RichstringPackage.RICH_STRING_ELSE_IF__THEN, null, msgs);
			msgs = basicSetThen(newThen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_ELSE_IF__THEN, newThen, newThen));
	}
