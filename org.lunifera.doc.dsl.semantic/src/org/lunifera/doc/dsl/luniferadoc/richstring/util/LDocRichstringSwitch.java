 ...
 * <!-- end-user-doc -->
 * @see org.lunifera.doc.dsl.luniferadoc.richstring.LDocRichstringPackage
 * @generated
 */
public class LDocRichstringSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static LDocRichstringPackage modelPackage;
	 ...
	 * @generated
	 */
	public LDocRichstringSwitch() {
		if (modelPackage == null) {
			modelPackage = LDocRichstringPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case LDocRichstringPackage.RICH_STRING_LITERAL: {
			...
			case LDocRichstringPackage.RICH_STRING_FOR_LOOP: {
			...
			case LDocRichstringPackage.RICH_STRING_IF: {
			...
			case LDocRichstringPackage.RICH_STRING_MARKUP: {
			...
			case LDocRichstringPackage.RICH_STRING_EXAMPLE: {
			...
			case LDocRichstringPackage.RICH_STRING_H1: {
			...
			case LDocRichstringPackage.RICH_STRING_H2: {
			...
			case LDocRichstringPackage.RICH_STRING_H3: {
			...
			case LDocRichstringPackage.RICH_STRING_H4: {
			...
			case LDocRichstringPackage.RICH_STRING_H5: {
			...
			case LDocRichstringPackage.RICH_STRING_H6: {
			...
			case LDocRichstringPackage.RICH_STRING_CHAPTER: {
			...
			case LDocRichstringPackage.RICH_STRING_SECTION: {
			...
			case LDocRichstringPackage.RICH_STRING_SUBSECTION: {
			...
			case LDocRichstringPackage.RICH_STRING_URL: {
			...
			case LDocRichstringPackage.RICH_STRING_REF: {
			...
			case LDocRichstringPackage.RICH_STRING_BOLD: {
			...
			case LDocRichstringPackage.RICH_STRING_UNDERLINE: {
			...
			case LDocRichstringPackage.RICH_STRING_ITALIC: {
			...
			case LDocRichstringPackage.RICH_STRING_IMG: {
			...
			case LDocRichstringPackage.RICH_STRING_MAILTO: {
			...
			case LDocRichstringPackage.RICH_STRING_SKYPE: {
			...
			case LDocRichstringPackage.RICH_STRING_MOVIE: {
			...
			case LDocRichstringPackage.RICH_STRING_CODE: {
			...
			case LDocRichstringPackage.RICH_STRING_TABLE: {
			...
			case LDocRichstringPackage.RICH_STRING_TABLE_ROW: {
			...
			case LDocRichstringPackage.RICH_STRING_OPEN_VIEW: {
			...
			case LDocRichstringPackage.RICH_STRING_START_PROCESS: {
			...
			case LDocRichstringPackage.RICH_STRING_ENTITY_REF: {
			...
			case LDocRichstringPackage.RICH_STRING_DTO_REF: {
			...
			case LDocRichstringPackage.RICH_STRING_PROCESS_REF: {
			...
			case LDocRichstringPackage.RICH_STRING_TASK_REF: {
			...
			case LDocRichstringPackage.RICH_STRING_VIEW_REF: {
			...
			case LDocRichstringPackage.RICH_STRING_UI_REF: {
			...
			case LDocRichstringPackage.RICH_STRING_LIST: {
			...
			case LDocRichstringPackage.RICH_STRING_ORDERED_LIST: {
			...
			case LDocRichstringPackage.RICH_STRING_LIST_ELEMENT: {
			...
			case LDocRichstringPackage.RICH_STRING_SPAN: {
