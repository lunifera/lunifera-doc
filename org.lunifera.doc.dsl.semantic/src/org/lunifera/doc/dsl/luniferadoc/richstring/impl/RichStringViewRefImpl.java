...
public class RichStringViewRefImpl extends RichStringMarkupImpl implements RichStringViewRef {
	...
	protected EClass eStaticClass() {
		return LDocRichstringPackage.Literals.RICH_STRING_VIEW_REF;
	}
		...
		if (viewDoc != null && viewDoc.eIsProxy()) {
			...
			if (viewDoc != oldViewDoc) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocRichstringPackage.RICH_STRING_VIEW_REF__VIEW_DOC, oldViewDoc, viewDoc));
			}
		}
		return viewDoc;
	}
	...
	public void setViewDoc(LDocViewDocument newViewDoc) {
		...
		viewDoc = newViewDoc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocRichstringPackage.RICH_STRING_VIEW_REF__VIEW_DOC, oldViewDoc, viewDoc));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocRichstringPackage.RICH_STRING_VIEW_REF__VIEW_DOC:
