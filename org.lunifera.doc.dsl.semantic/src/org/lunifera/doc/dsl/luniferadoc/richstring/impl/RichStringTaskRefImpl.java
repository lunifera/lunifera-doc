...
public class RichStringTaskRefImpl extends RichStringMarkupImpl implements RichStringTaskRef {
	...
	protected EClass eStaticClass() {
		return LDocRichstringPackage.Literals.RICH_STRING_TASK_REF;
	}
		...
		if (taskDoc != null && taskDoc.eIsProxy()) {
			...
			if (taskDoc != oldTaskDoc) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocRichstringPackage.RICH_STRING_TASK_REF__TASK_DOC, oldTaskDoc, taskDoc));
			}
		}
		return taskDoc;
	}
	...
	public void setTaskDoc(LDocHumanTaskDocument newTaskDoc) {
		...
		taskDoc = newTaskDoc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocRichstringPackage.RICH_STRING_TASK_REF__TASK_DOC, oldTaskDoc, taskDoc));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocRichstringPackage.RICH_STRING_TASK_REF__TASK_DOC:
