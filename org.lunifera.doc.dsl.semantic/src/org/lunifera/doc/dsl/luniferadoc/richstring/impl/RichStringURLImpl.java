...
public class RichStringURLImpl extends XExpressionImpl implements RichStringURL {
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_URL__LOCATION,
	...
	public void setText(XExpression newText) {
		if (newText != text) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_URL__TEXT, newText,
					newText));
	}
