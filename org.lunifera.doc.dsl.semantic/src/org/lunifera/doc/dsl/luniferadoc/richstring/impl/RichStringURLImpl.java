...
public class RichStringURLImpl extends XExpressionImpl implements RichStringURL {
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_URL__LOCATION, oldLocation, location));
	}
	...
	public NotificationChain basicSetText(XExpression newText, NotificationChain msgs) {
		...
		text = newText;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_URL__TEXT, oldText, newText);
	...
	public void setText(XExpression newText) {
		if (newText != text) {
			...
			if (text != null)
				msgs = ((InternalEObject)text).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RichstringPackage.RICH_STRING_URL__TEXT, null, msgs);
			if (newText != null)
				msgs = ((InternalEObject)newText).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RichstringPackage.RICH_STRING_URL__TEXT, null, msgs);
			msgs = basicSetText(newText, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RichstringPackage.RICH_STRING_URL__TEXT, newText, newText));
	}
