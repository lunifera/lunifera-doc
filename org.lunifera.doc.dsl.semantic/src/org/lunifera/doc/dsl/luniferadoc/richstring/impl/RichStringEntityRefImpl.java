...
public class RichStringEntityRefImpl extends RichStringMarkupImpl implements RichStringEntityRef {
	...
	protected EClass eStaticClass() {
		return LDocRichstringPackage.Literals.RICH_STRING_ENTITY_REF;
	}
		...
		if (entityDoc != null && entityDoc.eIsProxy()) {
			...
			if (entityDoc != oldEntityDoc) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocRichstringPackage.RICH_STRING_ENTITY_REF__ENTITY_DOC, oldEntityDoc, entityDoc));
			}
		}
		return entityDoc;
	}
	...
	public void setEntityDoc(LDocEntityDocument newEntityDoc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocRichstringPackage.RICH_STRING_ENTITY_REF__ENTITY_DOC, oldEntityDoc, entityDoc));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocRichstringPackage.RICH_STRING_ENTITY_REF__ENTITY_DOC:
