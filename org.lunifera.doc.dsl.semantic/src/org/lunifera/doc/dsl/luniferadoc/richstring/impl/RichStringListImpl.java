...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Rich String List</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class RichStringListImpl extends RichStringMarkupImpl implements RichStringList {
	...
	protected EClass eStaticClass() {
		return LDocRichstringPackage.Literals.RICH_STRING_LIST;
	}
	...
	public EList<RichStringListElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<RichStringListElement>(RichStringListElement.class, this, LDocRichstringPackage.RICH_STRING_LIST__ELEMENTS);
		}
		return elements;
	}
	...
	public EList<XExpression> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<XExpression>(XExpression.class, this, LDocRichstringPackage.RICH_STRING_LIST__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocRichstringPackage.RICH_STRING_LIST__ELEMENTS:
				return ((InternalEList<?>)getElements()).basicRemove(otherEnd, msgs);
			case LDocRichstringPackage.RICH_STRING_LIST__EXPRESSIONS:
