...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Rich String Mailto</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 ...
 * @generated
 */
public class RichStringMailtoImpl extends XExpressionImpl implements RichStringMailto {
	/**
	...
	protected EClass eStaticClass() {
		return RichstringPackage.Literals.RICH_STRING_MAILTO;
	}
	...
	public void setEmail(String newEmail) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_MAILTO__EMAIL, oldEmail, email));
	}
	...
	public NotificationChain basicSetContent(XExpression newContent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_MAILTO__CONTENT, oldContent, newContent);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject) content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- RichstringPackage.RICH_STRING_MAILTO__CONTENT, null, msgs);
			if (newContent != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_MAILTO__CONTENT, newContent, newContent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
		case RichstringPackage.RICH_STRING_MAILTO__CONTENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RichstringPackage.RICH_STRING_MAILTO__EMAIL:
			return getEmail();
		case RichstringPackage.RICH_STRING_MAILTO__CONTENT:
			return getContent();
		}
