 ...
 * <ul>
 * <li>{@link org.lunifera.doc.dsl.luniferadoc.richstring.RichStringEntityRef#getRefId <em>Ref Id</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface RichStringEntityRef extends RichStringMarkup {
	 ...
	 * @see #setRefId(String)
	 * @see org.lunifera.doc.dsl.luniferadoc.richstring.RichstringPackage#getRichStringEntityRef_RefId()
	 * @model
	 * @generated
	 */
	String getRefId();
	...
	/**
	 * Sets the value of the '{@link org.lunifera.doc.dsl.luniferadoc.richstring.RichStringEntityRef#getRefId
