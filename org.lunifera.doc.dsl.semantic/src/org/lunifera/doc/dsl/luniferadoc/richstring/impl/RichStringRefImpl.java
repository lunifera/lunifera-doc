...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Rich String Ref</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class RichStringRefImpl extends RichStringMarkupImpl implements RichStringRef {
	...
	protected EClass eStaticClass() {
		return RichstringPackage.Literals.RICH_STRING_REF;
	}
	...
	public void setRefId(String newRefId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_REF__REF_ID, oldRefId, refId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RichstringPackage.RICH_STRING_REF__REF_ID:
			return getRefId();
		}
