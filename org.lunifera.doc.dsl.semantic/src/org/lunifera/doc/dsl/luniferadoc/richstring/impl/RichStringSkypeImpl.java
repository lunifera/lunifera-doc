...
public class RichStringSkypeImpl extends RichStringMarkupImpl implements RichStringSkype {
	...
	protected EClass eStaticClass() {
		return LDocRichstringPackage.Literals.RICH_STRING_SKYPE;
	}
	...
	public void setTarget(String newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocRichstringPackage.RICH_STRING_SKYPE__TARGET, oldTarget, target));
	}
	...
	public NotificationChain basicSetContent(XExpression newContent, NotificationChain msgs) {
		...
		content = newContent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LDocRichstringPackage.RICH_STRING_SKYPE__CONTENT, oldContent, newContent);
	...
	public void setContent(XExpression newContent) {
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LDocRichstringPackage.RICH_STRING_SKYPE__CONTENT, null, msgs);
			if (newContent != null)
				msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LDocRichstringPackage.RICH_STRING_SKYPE__CONTENT, null, msgs);
			msgs = basicSetContent(newContent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocRichstringPackage.RICH_STRING_SKYPE__CONTENT, newContent, newContent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocRichstringPackage.RICH_STRING_SKYPE__CONTENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocRichstringPackage.RICH_STRING_SKYPE__TARGET:
				return getTarget();
			case LDocRichstringPackage.RICH_STRING_SKYPE__CONTENT:
				return getContent();
		}
