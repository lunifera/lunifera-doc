...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Rich String Skype</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 ...
 * @generated
 */
public class RichStringSkypeImpl extends XExpressionImpl implements RichStringSkype {
	/**
	...
	protected EClass eStaticClass() {
		return RichstringPackage.Literals.RICH_STRING_SKYPE;
	}
	...
	public void setTarget(String newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_SKYPE__TARGET, oldTarget, target));
	}
	...
	public NotificationChain basicSetContent(XExpression newContent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_SKYPE__CONTENT, oldContent, newContent);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject) content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- RichstringPackage.RICH_STRING_SKYPE__CONTENT, null, msgs);
			if (newContent != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RichstringPackage.RICH_STRING_SKYPE__CONTENT, newContent, newContent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
		case RichstringPackage.RICH_STRING_SKYPE__CONTENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RichstringPackage.RICH_STRING_SKYPE__TARGET:
			return getTarget();
		case RichstringPackage.RICH_STRING_SKYPE__CONTENT:
			return getContent();
		}
