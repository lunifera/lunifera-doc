...
public class LuniferaDocAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected LuniferaDocSwitch<Adapter> modelSwitch = new LuniferaDocSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.lunifera.doc.dsl.luniferadoc.DocumentInclude
	 * <em>Document Include</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
