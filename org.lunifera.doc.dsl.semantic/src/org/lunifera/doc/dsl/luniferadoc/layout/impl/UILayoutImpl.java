...
public class UILayoutImpl extends MinimalEObjectImpl.Container implements UILayout {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutPackage.UI_LAYOUT__NAME,
					oldName, name));
	}
	...
	public void setContent(RichString newContent) {
		if (newContent != content) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutPackage.UI_LAYOUT__CONTENT,
	...
	public EList<XImportDeclaration> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<XImportDeclaration>(XImportDeclaration.class,
					this, LayoutPackage.UI_LAYOUT__IMPORTS);
		}
		return imports;
	}
