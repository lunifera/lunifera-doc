...
public class DTOLayoutImpl extends MinimalEObjectImpl.Container implements DTOLayout {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutPackage.DTO_LAYOUT__NAME,
					oldName, name));
	}
	...
	public void setContent(RichString newContent) {
		if (newContent != content) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					LayoutPackage.DTO_LAYOUT__CONTENT, newContent, newContent));
	}
	...
	public EList<XImportDeclaration> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<XImportDeclaration>(XImportDeclaration.class,
					this, LayoutPackage.DTO_LAYOUT__IMPORTS);
		}
		return imports;
	}
