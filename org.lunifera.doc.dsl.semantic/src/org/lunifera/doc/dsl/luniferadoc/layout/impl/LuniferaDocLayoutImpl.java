...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Lunifera Doc Layout</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public abstract class LuniferaDocLayoutImpl extends MinimalEObjectImpl.Container implements LuniferaDocLayout {
	...
	public NotificationChain basicSetContent(RichString newContent, NotificationChain msgs) {
		...
		content = newContent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LayoutPackage.LUNIFERA_DOC_LAYOUT__CONTENT, oldContent, newContent);
	...
	public void setContent(RichString newContent) {
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LayoutPackage.LUNIFERA_DOC_LAYOUT__CONTENT, null, msgs);
			if (newContent != null)
				msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LayoutPackage.LUNIFERA_DOC_LAYOUT__CONTENT, null, msgs);
			msgs = basicSetContent(newContent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutPackage.LUNIFERA_DOC_LAYOUT__CONTENT, newContent, newContent));
	}
