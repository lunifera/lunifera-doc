...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>BPM Human Task Layout</b></em>'. <!--
 * end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class BPMHumanTaskLayoutImpl extends MinimalEObjectImpl.Container implements
		BPMHumanTaskLayout {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LayoutPackage.BPM_HUMAN_TASK_LAYOUT__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetContent(RichString newContent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LayoutPackage.BPM_HUMAN_TASK_LAYOUT__CONTENT, oldContent, newContent);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject) content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LayoutPackage.BPM_HUMAN_TASK_LAYOUT__CONTENT, null, msgs);
			if (newContent != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					LayoutPackage.BPM_HUMAN_TASK_LAYOUT__CONTENT, newContent, newContent));
	}
	...
	public EList<XImportDeclaration> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<XImportDeclaration>(XImportDeclaration.class,
					this, LayoutPackage.BPM_HUMAN_TASK_LAYOUT__IMPORTS);
		}
		return imports;
	}
