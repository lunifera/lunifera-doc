...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Entity Layout</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class EntityLayoutImpl extends MinimalEObjectImpl.Container implements EntityLayout {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutPackage.ENTITY_LAYOUT__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetContent(RichString newContent, NotificationChain msgs) {
		...
		content = newContent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LayoutPackage.ENTITY_LAYOUT__CONTENT, oldContent, newContent);
	...
	public void setContent(RichString newContent) {
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LayoutPackage.ENTITY_LAYOUT__CONTENT, null, msgs);
			if (newContent != null)
				msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LayoutPackage.ENTITY_LAYOUT__CONTENT, null, msgs);
			msgs = basicSetContent(newContent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutPackage.ENTITY_LAYOUT__CONTENT, newContent, newContent));
	}
	...
	public EList<XImportDeclaration> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<XImportDeclaration>(XImportDeclaration.class, this, LayoutPackage.ENTITY_LAYOUT__IMPORTS);
		}
		return imports;
	}
