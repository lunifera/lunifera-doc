...
public class LayoutSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case LayoutPackage.BPM_TASK_LAYOUT: {
			...
			if (result == null)
				result = caseLuniferaDocLayout(bpmTaskLayout);
			if (result == null)
				result = caseNamedDocument(bpmTaskLayout);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>BPM Task Layout</em>'. <!-- begin-user-doc
	 * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc
	 * -->
	 * 
	 * @param object
