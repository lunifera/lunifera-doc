...
public class VaaclipseViewLayoutImpl extends MinimalEObjectImpl.Container implements VaaclipseViewLayout {
	...
	protected EClass eStaticClass() {
		return LayoutPackage.Literals.VAACLIPSE_VIEW_LAYOUT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutPackage.VAACLIPSE_VIEW_LAYOUT__NAME, oldName,
					name));
	}
	...
	public void setContent(RichString newContent) {
		if (newContent != content) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LayoutPackage.VAACLIPSE_VIEW_LAYOUT__CONTENT,
	...
	public EList<XImportDeclaration> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<XImportDeclaration>(XImportDeclaration.class, this,
					LayoutPackage.VAACLIPSE_VIEW_LAYOUT__IMPORTS);
		}
		return imports;
	}
