...
public class LayoutPackageImpl extends EPackageImpl implements LayoutPackage {
	...
	public static LayoutPackage init() {
		...
		LayoutPackageImpl theLayoutPackage = (LayoutPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof LayoutPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new LayoutPackageImpl());
	...
	public void initializePackageContents() {
		...
		XtypePackage theXtypePackage = (XtypePackage) EPackage.Registry.INSTANCE
				.getEPackage(XtypePackage.eNS_URI);
		...
		initEClass(luniferaDocLayoutEClass, LuniferaDocLayout.class, "LuniferaDocLayout",
				IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLuniferaDocLayout_Content(), theRichstringPackage.getRichString(), null,
				"content", null, 0, 1, LuniferaDocLayout.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getLuniferaDocLayout_Imports(), theXtypePackage.getXImportDeclaration(),
				null, "imports", null, 0, -1, LuniferaDocLayout.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(entityLayoutEClass, EntityLayout.class, "EntityLayout", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(dtoLayoutEClass, DTOLayout.class, "DTOLayout", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(bpmProcessLayoutEClass, BPMProcessLayout.class, "BPMProcessLayout",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(bpmHumanTaskLayoutEClass, BPMHumanTaskLayout.class, "BPMHumanTaskLayout",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(vaaclipseViewLayoutEClass, VaaclipseViewLayout.class, "VaaclipseViewLayout",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(uiLayoutEClass, UILayout.class, "UILayout", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
	}
