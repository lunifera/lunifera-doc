...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>LDoc BPM Process Document</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.impl.LDocBPMProcessDocumentImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.impl.LDocBPMProcessDocumentImpl#getLocale <em>Locale</em>}</li>
...
public class LDocBPMProcessDocumentImpl extends MinimalEObjectImpl.Container implements LDocBPMProcessDocument {
	...
	protected EClass eStaticClass() {
		return LunDocPackage.Literals.LDOC_BPM_PROCESS_DOCUMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__NAME, oldName, name));
	}
	...
	public void setLocale(String newLocale) {
		...
		locale = newLocale;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__LOCALE, oldLocale, locale));
	}
	...
	public NotificationChain basicSetDescription(RichString newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__DESCRIPTION, oldDescription, newDescription);
	...
	public void setDescription(RichString newDescription) {
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__DESCRIPTION, null, msgs);
			if (newDescription != null)
				msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__DESCRIPTION, null, msgs);
			msgs = basicSetDescription(newDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__DESCRIPTION, newDescription, newDescription));
	}
	...
	public void setProcess(String newProcess) {
		...
		process = newProcess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__PROCESS, oldProcess, process));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__DESCRIPTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__NAME:
				return getName();
			case LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__LOCALE:
				return getLocale();
			case LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__DESCRIPTION:
				return getDescription();
			case LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__PROCESS:
				return getProcess();
		}
