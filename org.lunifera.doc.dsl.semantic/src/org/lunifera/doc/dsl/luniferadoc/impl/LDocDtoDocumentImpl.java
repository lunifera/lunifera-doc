 ...
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.impl.LDocDtoDocumentImpl#getLocale <em>Locale</em>}</li>
...
public class LDocDtoDocumentImpl extends MinimalEObjectImpl.Container implements LDocDtoDocument {
	...
	public void setLocale(String newLocale) {
		...
		locale = newLocale;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocPackage.LDOC_DTO_DOCUMENT__LOCALE, oldLocale, locale));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunDocPackage.LDOC_DTO_DOCUMENT__NAME:
				return getName();
			case LunDocPackage.LDOC_DTO_DOCUMENT__LOCALE:
				return getLocale();
			case LunDocPackage.LDOC_DTO_DOCUMENT__DESCRIPTION:
