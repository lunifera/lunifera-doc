 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.impl.DTODocumentImpl#getDtoClass <em>Dto Class</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.impl.DTODocumentImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.impl.DTODocumentImpl#getDetails <em>Details</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DTODocumentImpl extends LuniferaDocDocumentImpl implements DTODocument {
	...
	protected EClass eStaticClass() {
		return LuniferaDocPackage.Literals.DTO_DOCUMENT;
	}
	...
	public void setDtoClass(String newDtoClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LuniferaDocPackage.DTO_DOCUMENT__DTO_CLASS, oldDtoClass, dtoClass));
	}
	...
	public NotificationChain basicSetHeader(DTOHeader newHeader, NotificationChain msgs) {
		...
		header = newHeader;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LuniferaDocPackage.DTO_DOCUMENT__HEADER, oldHeader, newHeader);
	...
	public void setHeader(DTOHeader newHeader) {
		if (newHeader != header) {
			...
			if (header != null)
				msgs = ((InternalEObject)header).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LuniferaDocPackage.DTO_DOCUMENT__HEADER, null, msgs);
			if (newHeader != null)
				msgs = ((InternalEObject)newHeader).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LuniferaDocPackage.DTO_DOCUMENT__HEADER, null, msgs);
			msgs = basicSetHeader(newHeader, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LuniferaDocPackage.DTO_DOCUMENT__HEADER, newHeader, newHeader));
	}
	...
	public NotificationChain basicSetDetails(DTODetails newDetails, NotificationChain msgs) {
		...
		details = newDetails;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LuniferaDocPackage.DTO_DOCUMENT__DETAILS, oldDetails, newDetails);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDetails(DTODetails newDetails) {
		if (newDetails != details) {
			NotificationChain msgs = null;
			if (details != null)
				msgs = ((InternalEObject)details).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LuniferaDocPackage.DTO_DOCUMENT__DETAILS, null, msgs);
			if (newDetails != null)
				msgs = ((InternalEObject)newDetails).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LuniferaDocPackage.DTO_DOCUMENT__DETAILS, null, msgs);
			msgs = basicSetDetails(newDetails, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LuniferaDocPackage.DTO_DOCUMENT__DETAILS, newDetails, newDetails));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LuniferaDocPackage.DTO_DOCUMENT__HEADER:
				return basicSetHeader(null, msgs);
			case LuniferaDocPackage.DTO_DOCUMENT__DETAILS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LuniferaDocPackage.DTO_DOCUMENT__DTO_CLASS:
				return getDtoClass();
			case LuniferaDocPackage.DTO_DOCUMENT__HEADER:
				return getHeader();
			case LuniferaDocPackage.DTO_DOCUMENT__DETAILS:
