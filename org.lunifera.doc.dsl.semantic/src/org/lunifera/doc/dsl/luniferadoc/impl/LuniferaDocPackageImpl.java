...
public class LuniferaDocPackageImpl extends EPackageImpl implements LuniferaDocPackage {
	...
	public static LuniferaDocPackage init() {
		if (isInited)
			return (LuniferaDocPackage) EPackage.Registry.INSTANCE.getEPackage(LuniferaDocPackage.eNS_URI);

		// Obtain or create and register package
		LuniferaDocPackageImpl theLuniferaDocPackage = (LuniferaDocPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof LuniferaDocPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
				: new LuniferaDocPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(namedDocumentEClass, NamedDocument.class, "NamedDocument", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNamedDocument_Name(), ecorePackage.getEString(), "name", null, 0, 1, NamedDocument.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(documentIncludeEClass, DocumentInclude.class, "DocumentInclude", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDocumentInclude_Include(), theDocumentPackage.getLuniferaDocDocument(), null, "include",
				null, 0, 1, DocumentInclude.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumentInclude_VarName(), ecorePackage.getEString(), "varName", null, 1, 1,
				DocumentInclude.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
