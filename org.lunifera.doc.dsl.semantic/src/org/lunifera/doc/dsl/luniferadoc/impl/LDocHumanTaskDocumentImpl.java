...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Human Task Document</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class LDocHumanTaskDocumentImpl extends MinimalEObjectImpl.Container implements LDocHumanTaskDocument {
	...
	protected EClass eStaticClass() {
		return LDocPackage.Literals.LDOC_HUMAN_TASK_DOCUMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__NAME, oldName, name));
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__LANGUAGE, oldLanguage, language));
	}
	...
	public NotificationChain basicSetDescription(RichString newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__DESCRIPTION, oldDescription, newDescription);
	...
	public void setDescription(RichString newDescription) {
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__DESCRIPTION, null, msgs);
			if (newDescription != null)
				msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__DESCRIPTION, null, msgs);
			msgs = basicSetDescription(newDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__DESCRIPTION, newDescription, newDescription));
	}
	...
	public void setTask(String newTask) {
		...
		task = newTask;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__TASK, oldTask, task));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__DESCRIPTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__NAME:
				return getName();
			case LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__LANGUAGE:
				return getLanguage();
			case LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__DESCRIPTION:
				return getDescription();
			case LDocPackage.LDOC_HUMAN_TASK_DOCUMENT__TASK:
				return getTask();
		}
