...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Layouter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class LDocLayouterImpl extends MinimalEObjectImpl.Container implements LDocLayouter {
	...
	protected EClass eStaticClass() {
		return LDocPackage.Literals.LDOC_LAYOUTER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocPackage.LDOC_LAYOUTER__NAME, oldName, name));
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocPackage.LDOC_LAYOUTER__LANGUAGE, oldLanguage, language));
	}
	...
	public NotificationChain basicSetContent(RichString newContent, NotificationChain msgs) {
		...
		content = newContent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LDocPackage.LDOC_LAYOUTER__CONTENT, oldContent, newContent);
	...
	public void setContent(RichString newContent) {
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LDocPackage.LDOC_LAYOUTER__CONTENT, null, msgs);
			if (newContent != null)
				msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LDocPackage.LDOC_LAYOUTER__CONTENT, null, msgs);
			msgs = basicSetContent(newContent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocPackage.LDOC_LAYOUTER__CONTENT, newContent, newContent));
	}
	...
	public EList<XImportDeclaration> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<XImportDeclaration>(XImportDeclaration.class, this, LDocPackage.LDOC_LAYOUTER__IMPORTS);
		}
		return imports;
	}
	...
	public EList<LDocInclude> getIncludes() {
		if (includes == null) {
			includes = new EObjectContainmentEList<LDocInclude>(LDocInclude.class, this, LDocPackage.LDOC_LAYOUTER__INCLUDES);
		}
		return includes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocPackage.LDOC_LAYOUTER__CONTENT:
				return basicSetContent(null, msgs);
			case LDocPackage.LDOC_LAYOUTER__IMPORTS:
				return ((InternalEList<?>)getImports()).basicRemove(otherEnd, msgs);
			case LDocPackage.LDOC_LAYOUTER__INCLUDES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocPackage.LDOC_LAYOUTER__NAME:
				return getName();
			case LDocPackage.LDOC_LAYOUTER__LANGUAGE:
				return getLanguage();
			case LDocPackage.LDOC_LAYOUTER__CONTENT:
				return getContent();
			case LDocPackage.LDOC_LAYOUTER__IMPORTS:
