 ...
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.impl.LDocUIDocumentImpl#getLocale <em>Locale</em>}</li>
...
public class LDocUIDocumentImpl extends MinimalEObjectImpl.Container implements LDocUIDocument {
	...
	public void setLocale(String newLocale) {
		...
		locale = newLocale;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocPackage.LDOC_UI_DOCUMENT__LOCALE, oldLocale, locale));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunDocPackage.LDOC_UI_DOCUMENT__NAME:
				return getName();
			case LunDocPackage.LDOC_UI_DOCUMENT__LOCALE:
				return getLocale();
			case LunDocPackage.LDOC_UI_DOCUMENT__DESCRIPTION:
