...
public class DocumentIncludeImpl extends MinimalEObjectImpl.Container implements DocumentInclude {
	...
	public void setInclude(LuniferaDocDocument newInclude) {
		...
		include = newInclude;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LuniferaDocPackage.DOCUMENT_INCLUDE__INCLUDE,
					oldInclude, include));
	}
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LuniferaDocPackage.DOCUMENT_INCLUDE__VAR_NAME,
					oldVarName, varName));
	}
