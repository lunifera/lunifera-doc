 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.impl.GeneralDocumentImpl#getIncludes <em>Includes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralDocumentImpl extends LuniferaDocLayoutImpl implements GeneralDocument {
	...
	protected EClass eStaticClass() {
		return LuniferaDocPackage.Literals.GENERAL_DOCUMENT;
	}
	...
	public EList<DocumentInclude> getIncludes() {
		if (includes == null) {
			includes = new EObjectContainmentEList<DocumentInclude>(DocumentInclude.class, this, LuniferaDocPackage.GENERAL_DOCUMENT__INCLUDES);
		}
		return includes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LuniferaDocPackage.GENERAL_DOCUMENT__INCLUDES:
