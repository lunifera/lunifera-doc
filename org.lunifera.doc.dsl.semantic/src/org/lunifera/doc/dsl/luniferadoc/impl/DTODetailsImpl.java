 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.impl.DTODetailsImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DTODetailsImpl extends MinimalEObjectImpl.Container implements DTODetails {
	...
	protected EClass eStaticClass() {
		return LuniferaDocPackage.Literals.DTO_DETAILS;
	}
	...
	public EList<DTOProperty> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<DTOProperty>(DTOProperty.class, this, LuniferaDocPackage.DTO_DETAILS__PROPERTIES);
		}
		return properties;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LuniferaDocPackage.DTO_DETAILS__PROPERTIES:
