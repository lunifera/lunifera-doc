...
public class MarkupPackageImpl extends EPackageImpl implements MarkupPackage {
	 ...
	 * @generated
	 */
	private EClass tagImgEClass = null;
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link MarkupPackage#eINSTANCE} when that field is accessed. Clients should not
	...
	public static MarkupPackage init() {
		...
		MarkupPackageImpl theMarkupPackage = (MarkupPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof MarkupPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new MarkupPackageImpl());
	 ...
	 * @generated
	 */
	public EAttribute getTagImg_Src() {
		return (EAttribute) tagImgEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		tagImgEClass = createEClass(TAG_IMG);
		createEAttribute(tagImgEClass, TAG_IMG__SRC);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(tagImgEClass, TagImg.class, "TagImg", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTagImg_Src(), ecorePackage.getEString(), "src", null, 1, 1, TagImg.class,
