...
public class MarkupSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MarkupPackage.TAG_IMG: {
			TagImg tagImg = (TagImg) theEObject;
			T result = caseTagImg(tagImg);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tag Img</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tag Img</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTagImg(TagImg object) {
		return null;
	}
