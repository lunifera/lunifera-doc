...
public class MarkupSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MarkupPackage.TAG_URL: {
			TagURL tagURL = (TagURL) theEObject;
			T result = caseTagURL(tagURL);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tag URL</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tag URL</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTagURL(TagURL object) {
		return null;
	}
