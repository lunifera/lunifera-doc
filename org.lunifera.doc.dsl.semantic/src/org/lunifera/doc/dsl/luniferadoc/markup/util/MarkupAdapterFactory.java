/**
 */
package org.lunifera.doc.dsl.luniferadoc.markup.util;
...
public class MarkupAdapterFactory extends AdapterFactoryImpl {
	...
	protected MarkupSwitch<Adapter> modelSwitch = new MarkupSwitch<Adapter>() {
		@Override
		public Adapter caseTagImg(TagImg object) {
			return createTagImgAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.lunifera.doc.dsl.luniferadoc.markup.TagImg
	 * <em>Tag Img</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 ...
	 * @generated
	 */
	public Adapter createTagImgAdapter() {
		return null;
	}
