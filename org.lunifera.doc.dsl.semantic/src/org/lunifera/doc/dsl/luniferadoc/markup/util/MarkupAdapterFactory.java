...
public class MarkupAdapterFactory extends AdapterFactoryImpl {
	...
	protected MarkupSwitch<Adapter> modelSwitch =
			new MarkupSwitch<Adapter>() {
				@Override
				public Adapter caseTagURL(TagURL object) {
					return createTagURLAdapter();
				}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.lunifera.doc.dsl.luniferadoc.markup.TagURL
	 * <em>Tag URL</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 ...
	 * @generated
	 */
	public Adapter createTagURLAdapter() {
		return null;
	}
