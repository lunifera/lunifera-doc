...
public class DocumentPackageImpl extends EPackageImpl implements DocumentPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getBPMProcessDocument_Process(), ecorePackage.getEString(), "process", null, 0, 1, BPMProcessDocument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBPMProcessDocument_Description(), this.getBPMProcessDescription(), null, "description", null, 0, 1, BPMProcessDocument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bpmProcessDescriptionEClass, BPMProcessDescription.class, "BPMProcessDescription", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
