...
public class DTODocumentImpl extends MinimalEObjectImpl.Container implements DTODocument {
	...
	public void setDtoClass(String newDtoClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentPackage.DTO_DOCUMENT__DTO_CLASS, oldDtoClass,
					dtoClass));
	}
	...
	public void setDescription(DTODescription newDescription) {
		if (newDescription != description) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentPackage.DTO_DOCUMENT__DESCRIPTION,
	...
	public void setProperties(DTOProperties newProperties) {
		if (newProperties != properties) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentPackage.DTO_DOCUMENT__PROPERTIES,
