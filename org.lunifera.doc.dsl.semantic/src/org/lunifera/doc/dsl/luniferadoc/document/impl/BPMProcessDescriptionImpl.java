...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>BPM Process Description</b></em>'. <!--
 * end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class BPMProcessDescriptionImpl extends MinimalEObjectImpl.Container implements
	...
	public NotificationChain basicSetContent(RichString newContent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocumentPackage.BPM_PROCESS_DESCRIPTION__CONTENT, oldContent, newContent);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject) content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- DocumentPackage.BPM_PROCESS_DESCRIPTION__CONTENT, null, msgs);
			if (newContent != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.BPM_PROCESS_DESCRIPTION__CONTENT, newContent, newContent));
	}
