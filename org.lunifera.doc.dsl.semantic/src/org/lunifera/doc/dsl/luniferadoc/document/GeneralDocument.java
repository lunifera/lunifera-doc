...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>General Document</b></em>'. <!-- end-user-doc
 * -->
 * 
 * <p>
...
public interface GeneralDocument extends LuniferaDocLayout {
	/**
	 * Returns the value of the '<em><b>Includes</b></em>' containment reference list. The list contents are of type
	 * {@link org.lunifera.doc.dsl.luniferadoc.DocumentInclude}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Includes</em>' containment reference list isn't clear, there really should be more of
	 * a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
