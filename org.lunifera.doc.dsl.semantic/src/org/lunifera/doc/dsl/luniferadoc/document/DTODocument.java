...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>DTO Document</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface DTODocument extends LuniferaDocDocument {
	/**
	 * Returns the value of the '<em><b>Dto Class</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Dto Class</em>' attribute isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.lunifera.doc.dsl.luniferadoc.document.DTODocument#getDtoClass
	 * <em>Dto Class</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Dto Class</em>' attribute.
	 * @see #getDtoClass()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.lunifera.doc.dsl.luniferadoc.document.DTODocument#getDescription
	...
	/**
	 * Sets the value of the '{@link org.lunifera.doc.dsl.luniferadoc.document.DTODocument#getProperties
