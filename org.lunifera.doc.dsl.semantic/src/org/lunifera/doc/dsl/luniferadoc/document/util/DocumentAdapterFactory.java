...
public class DocumentAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.lunifera.doc.dsl.luniferadoc.document.BPMProcessDescription <em>BPM Process Description</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.lunifera.doc.dsl.luniferadoc.document.BPMHumanTaskDocument <em>BPM Human Task Document</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.lunifera.doc.dsl.luniferadoc.document.BPMHumanTaskDescription <em>BPM Human Task Description</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.lunifera.doc.dsl.luniferadoc.document.VaaclipseViewDescription <em>Vaaclipse View Description</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.lunifera.doc.dsl.luniferadoc.document.UIDescription
	 * <em>UI Description</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	 * ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	 * @return the new adapter.
