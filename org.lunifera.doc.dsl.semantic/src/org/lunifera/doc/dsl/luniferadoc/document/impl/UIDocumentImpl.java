...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>UI Document</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class UIDocumentImpl extends MinimalEObjectImpl.Container implements UIDocument {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.UI_DOCUMENT__NAME, oldName, name));
	}
	...
	public void setUi(String newUi) {
		...
		ui = newUi;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentPackage.UI_DOCUMENT__UI,
					oldUi, ui));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDescription(UIDescription newDescription,
			NotificationChain msgs) {
		UIDescription oldDescription = description;
		description = newDescription;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocumentPackage.UI_DOCUMENT__DESCRIPTION, oldDescription, newDescription);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject) description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- DocumentPackage.UI_DOCUMENT__DESCRIPTION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.UI_DOCUMENT__DESCRIPTION, newDescription, newDescription));
	}
