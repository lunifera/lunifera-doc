...
public class EntityFieldImpl extends MinimalEObjectImpl.Container implements EntityField {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.ENTITY_FIELD__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.ENTITY_FIELD__TYPE, oldType, type));
	}
	...
	public void setLength(int newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.ENTITY_FIELD__LENGTH, oldLength, length));
	}
	...
	public void setPk(boolean newPk) {
		...
		pk = newPk;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentPackage.ENTITY_FIELD__PK,
					oldPk, pk));
	}
	...
	public void setNullable(boolean newNullable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.ENTITY_FIELD__NULLABLE, oldNullable, nullable));
	}
	...
	public void setDescription(RichString newDescription) {
		if (newDescription != description) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.ENTITY_FIELD__DESCRIPTION, newDescription, newDescription));
	}
