...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>General Document</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class GeneralDocumentImpl extends MinimalEObjectImpl.Container implements GeneralDocument {
	...
	public NotificationChain basicSetContent(RichString newContent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DocumentPackage.GENERAL_DOCUMENT__CONTENT, oldContent, newContent);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject) content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- DocumentPackage.GENERAL_DOCUMENT__CONTENT, null, msgs);
			if (newContent != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentPackage.GENERAL_DOCUMENT__CONTENT,
	...
	public EList<XImportDeclaration> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<XImportDeclaration>(XImportDeclaration.class, this,
					DocumentPackage.GENERAL_DOCUMENT__IMPORTS);
		}
		return imports;
	}
	...
	public EList<DocumentInclude> getIncludes() {
		if (includes == null) {
			includes = new EObjectContainmentEList<DocumentInclude>(DocumentInclude.class, this,
					DocumentPackage.GENERAL_DOCUMENT__INCLUDES);
		}
		return includes;
	}
