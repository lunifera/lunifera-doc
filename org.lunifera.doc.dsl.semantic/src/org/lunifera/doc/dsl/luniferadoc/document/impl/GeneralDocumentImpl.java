...
public class GeneralDocumentImpl extends MinimalEObjectImpl.Container implements GeneralDocument {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.GENERAL_DOCUMENT__NAME, oldName, name));
	}
	...
	public void setContent(RichString newContent) {
		if (newContent != content) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.GENERAL_DOCUMENT__CONTENT, newContent, newContent));
	}
	...
	public EList<XImportDeclaration> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<XImportDeclaration>(XImportDeclaration.class,
					this, DocumentPackage.GENERAL_DOCUMENT__IMPORTS);
		}
		return imports;
	}
