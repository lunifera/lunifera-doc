...
public class EntityDocumentImpl extends MinimalEObjectImpl.Container implements EntityDocument {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.ENTITY_DOCUMENT__NAME, oldName, name));
	}
	...
	public void setEntityClass(String newEntityClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.ENTITY_DOCUMENT__ENTITY_CLASS, oldEntityClass, entityClass));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDescription(EntityDescription newDescription,
	...
	public void setDescription(EntityDescription newDescription) {
		if (newDescription != description) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.ENTITY_DOCUMENT__DESCRIPTION, newDescription, newDescription));
	}
	...
	public void setFields(EntityFields newFields) {
		if (newFields != fields) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DocumentPackage.ENTITY_DOCUMENT__FIELDS, newFields, newFields));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case DocumentPackage.ENTITY_DOCUMENT__ENTITY_CLASS:
			return ENTITY_CLASS_EDEFAULT == null ? entityClass != null : !ENTITY_CLASS_EDEFAULT
					.equals(entityClass);
		case DocumentPackage.ENTITY_DOCUMENT__DESCRIPTION:
