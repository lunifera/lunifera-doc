...
public class EntityDocumentImpl extends LuniferaDocDocumentImpl implements EntityDocument {
	...
	public void setEntityClass(String newEntityClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentPackage.ENTITY_DOCUMENT__ENTITY_CLASS, oldEntityClass, entityClass));
	}
	...
	public NotificationChain basicSetDescription(EntityDescription newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocumentPackage.ENTITY_DOCUMENT__DESCRIPTION, oldDescription, newDescription);
	...
	public void setDescription(EntityDescription newDescription) {
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocumentPackage.ENTITY_DOCUMENT__DESCRIPTION, null, msgs);
			if (newDescription != null)
				msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocumentPackage.ENTITY_DOCUMENT__DESCRIPTION, null, msgs);
			msgs = basicSetDescription(newDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentPackage.ENTITY_DOCUMENT__DESCRIPTION, newDescription, newDescription));
	}
	...
	public NotificationChain basicSetFields(EntityFields newFields, NotificationChain msgs) {
		...
		fields = newFields;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocumentPackage.ENTITY_DOCUMENT__FIELDS, oldFields, newFields);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFields(EntityFields newFields) {
		if (newFields != fields) {
			NotificationChain msgs = null;
			if (fields != null)
				msgs = ((InternalEObject)fields).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocumentPackage.ENTITY_DOCUMENT__FIELDS, null, msgs);
			if (newFields != null)
				msgs = ((InternalEObject)newFields).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocumentPackage.ENTITY_DOCUMENT__FIELDS, null, msgs);
			msgs = basicSetFields(newFields, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentPackage.ENTITY_DOCUMENT__FIELDS, newFields, newFields));
	}
