...
public interface LuniferaDocFactory extends EFactory {
	 ...
	 * @generated
	 */
	LuniferaDocFactory eINSTANCE = org.lunifera.doc.dsl.luniferadoc.impl.LuniferaDocFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>Document Include</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
