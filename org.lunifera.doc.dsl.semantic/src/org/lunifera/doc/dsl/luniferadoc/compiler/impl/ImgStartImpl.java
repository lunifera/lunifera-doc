 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ImgStartImpl#getContent <em>Content</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImgStartImpl extends LinePartImpl implements ImgStart {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.IMG_START;
	}
		...
		if (content != null && content.eIsProxy()) {
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.IMG_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public void setContent(RichStringImg newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.IMG_START__CONTENT, oldContent, content));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.IMG_START__CONTENT:
