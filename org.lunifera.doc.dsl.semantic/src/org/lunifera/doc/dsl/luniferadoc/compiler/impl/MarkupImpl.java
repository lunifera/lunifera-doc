 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.MarkupImpl#getMarkup <em>Markup</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MarkupImpl extends LinePartImpl implements Markup {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.MARKUP;
	}
		...
		if (markup != null && markup.eIsProxy()) {
			...
			if (markup != oldMarkup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.MARKUP__MARKUP, oldMarkup, markup));
			}
		}
		return markup;
	}
	...
	public void setMarkup(RichStringMarkup newMarkup) {
		...
		markup = newMarkup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.MARKUP__MARKUP, oldMarkup, markup));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.MARKUP__MARKUP:
