 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ExampleStartImpl#getContent <em>Content</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ExampleStartImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExampleStartImpl extends LinePartImpl implements ExampleStart {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.EXAMPLE_START;
	}
		...
		if (content != null && content.eIsProxy()) {
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.EXAMPLE_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public void setContent(RichStringExample newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.EXAMPLE_START__CONTENT, oldContent, content));
	}
	...
	public ExampleEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.EXAMPLE_START__END, oldEnd, end));
			}
		}
		return end;
	}
	...
	public NotificationChain basicSetEnd(ExampleEnd newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.EXAMPLE_START__END, oldEnd, newEnd);
	...
	public void setEnd(ExampleEnd newEnd) {
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject)end).eInverseRemove(this, LDocCompilerPackage.EXAMPLE_END__START, ExampleEnd.class, msgs);
			if (newEnd != null)
				msgs = ((InternalEObject)newEnd).eInverseAdd(this, LDocCompilerPackage.EXAMPLE_END__START, ExampleEnd.class, msgs);
			msgs = basicSetEnd(newEnd, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.EXAMPLE_START__END, newEnd, newEnd));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocCompilerPackage.EXAMPLE_START__END:
				if (end != null)
					msgs = ((InternalEObject)end).eInverseRemove(this, LDocCompilerPackage.EXAMPLE_END__START, ExampleEnd.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.EXAMPLE_START__CONTENT:
