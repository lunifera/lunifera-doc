 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.EndIfImpl#getIfConditionStart <em>If Condition Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EndIfImpl extends LinePartImpl implements EndIf {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.END_IF;
	}
		...
		if (ifConditionStart != null && ifConditionStart.eIsProxy()) {
			...
			if (ifConditionStart != oldIfConditionStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.END_IF__IF_CONDITION_START, oldIfConditionStart, ifConditionStart));
			}
		}
	...
	public void setIfConditionStart(IfConditionStart newIfConditionStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.END_IF__IF_CONDITION_START, oldIfConditionStart, ifConditionStart));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.END_IF__IF_CONDITION_START:
