 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.UnderlineEndImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnderlineEndImpl extends LinePartImpl implements UnderlineEnd {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.UNDERLINE_END;
	}
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.UNDERLINE_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public void setStart(UnderlineStart newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.UNDERLINE_END__START, oldStart, start));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.UNDERLINE_END__START:
