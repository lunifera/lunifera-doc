 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.OrderedListStartImpl#getContent <em>Content</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.OrderedListStartImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.OrderedListStartImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderedListStartImpl extends LinePartImpl implements OrderedListStart {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.ORDERED_LIST_START;
	}
		...
		if (content != null && content.eIsProxy()) {
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.ORDERED_LIST_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public void setContent(RichStringOrderedList newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.ORDERED_LIST_START__CONTENT, oldContent, content));
	}
	...
	public EList<ListElementStart> getElements() {
		if (elements == null) {
			elements = new EObjectResolvingEList<ListElementStart>(ListElementStart.class, this, LDocCompilerPackage.ORDERED_LIST_START__ELEMENTS);
		}
		return elements;
	}
	...
	public OrderedListEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.ORDERED_LIST_START__END, oldEnd, end));
			}
		}
		return end;
	}
	...
	public void setEnd(OrderedListEnd newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.ORDERED_LIST_START__END, oldEnd, end));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.ORDERED_LIST_START__CONTENT:
				if (resolve) return getContent();
				return basicGetContent();
			case LDocCompilerPackage.ORDERED_LIST_START__ELEMENTS:
				return getElements();
			case LDocCompilerPackage.ORDERED_LIST_START__END:
