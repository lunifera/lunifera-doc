 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.TableStartImpl#getContent <em>Content</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.TableStartImpl#getRows <em>Rows</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.TableStartImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableStartImpl extends LinePartImpl implements TableStart {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.TABLE_START;
	}
		...
		if (content != null && content.eIsProxy()) {
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.TABLE_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public void setContent(RichStringTable newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.TABLE_START__CONTENT, oldContent, content));
	}
	...
	public EList<RichStringTableRow> getRows() {
		if (rows == null) {
			rows = new EObjectResolvingEList<RichStringTableRow>(RichStringTableRow.class, this, LDocCompilerPackage.TABLE_START__ROWS);
		}
		return rows;
	}
	...
	public TableEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.TABLE_START__END, oldEnd, end));
			}
		}
		return end;
	}
	...
	public void setEnd(TableEnd newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.TABLE_START__END, oldEnd, end));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.TABLE_START__CONTENT:
				if (resolve) return getContent();
				return basicGetContent();
			case LDocCompilerPackage.TABLE_START__ROWS:
				return getRows();
			case LDocCompilerPackage.TABLE_START__END:
