 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.OrderedListEndImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderedListEndImpl extends LinePartImpl implements OrderedListEnd {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.ORDERED_LIST_END;
	}
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.ORDERED_LIST_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public void setStart(OrderedListStart newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.ORDERED_LIST_END__START, oldStart, start));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.ORDERED_LIST_END__START:
