 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ForLoopStartImpl#getLoop <em>Loop</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ForLoopStartImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForLoopStartImpl extends LinePartImpl implements ForLoopStart {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.FOR_LOOP_START;
	}
		...
		if (loop != null && loop.eIsProxy()) {
			...
			if (loop != oldLoop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.FOR_LOOP_START__LOOP, oldLoop, loop));
			}
		}
		return loop;
	}
	...
	public void setLoop(RichStringForLoop newLoop) {
		...
		loop = newLoop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.FOR_LOOP_START__LOOP, oldLoop, loop));
	}
	...
	public ForLoopEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.FOR_LOOP_START__END, oldEnd, end));
			}
		}
		return end;
	}
	...
	public NotificationChain basicSetEnd(ForLoopEnd newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.FOR_LOOP_START__END, oldEnd, newEnd);
	...
	public void setEnd(ForLoopEnd newEnd) {
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject)end).eInverseRemove(this, LDocCompilerPackage.FOR_LOOP_END__START, ForLoopEnd.class, msgs);
			if (newEnd != null)
				msgs = ((InternalEObject)newEnd).eInverseAdd(this, LDocCompilerPackage.FOR_LOOP_END__START, ForLoopEnd.class, msgs);
			msgs = basicSetEnd(newEnd, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.FOR_LOOP_START__END, newEnd, newEnd));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocCompilerPackage.FOR_LOOP_START__END:
				if (end != null)
					msgs = ((InternalEObject)end).eInverseRemove(this, LDocCompilerPackage.FOR_LOOP_END__START, ForLoopEnd.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.FOR_LOOP_START__LOOP:
