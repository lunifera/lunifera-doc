 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.DTORefEndImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DTORefEndImpl extends LinePartImpl implements DTORefEnd {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.DTO_REF_END;
	}
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.DTO_REF_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public NotificationChain basicSetStart(DTORefStart newStart, NotificationChain msgs) {
		...
		start = newStart;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.DTO_REF_END__START, oldStart, newStart);
	...
	public void setStart(DTORefStart newStart) {
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject)start).eInverseRemove(this, LDocCompilerPackage.DTO_REF_START__END, DTORefStart.class, msgs);
			if (newStart != null)
				msgs = ((InternalEObject)newStart).eInverseAdd(this, LDocCompilerPackage.DTO_REF_START__END, DTORefStart.class, msgs);
			msgs = basicSetStart(newStart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.DTO_REF_END__START, newStart, newStart));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocCompilerPackage.DTO_REF_END__START:
				if (start != null)
					msgs = ((InternalEObject)start).eInverseRemove(this, LDocCompilerPackage.DTO_REF_START__END, DTORefStart.class, msgs);
