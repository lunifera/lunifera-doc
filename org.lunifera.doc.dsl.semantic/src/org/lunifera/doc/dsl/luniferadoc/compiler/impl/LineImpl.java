 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.LineImpl#getParts <em>Parts</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.LineImpl#getRichString <em>Rich String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineImpl extends MinimalEObjectImpl.Container implements Line {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.LINE;
	}
	...
	public EList<LinePart> getParts() {
		if (parts == null) {
			parts = new EObjectContainmentWithInverseEList<LinePart>(LinePart.class, this, LDocCompilerPackage.LINE__PARTS, LDocCompilerPackage.LINE_PART__LINE);
		}
		return parts;
	}
	...
	public ProcessedRichString getRichString() {
		if (eContainerFeatureID() != LDocCompilerPackage.LINE__RICH_STRING) return null;
	...
	public NotificationChain basicSetRichString(ProcessedRichString newRichString, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newRichString, LDocCompilerPackage.LINE__RICH_STRING, msgs);
		return msgs;
	}
	...
	public void setRichString(ProcessedRichString newRichString) {
		if (newRichString != eInternalContainer() || (eContainerFeatureID() != LDocCompilerPackage.LINE__RICH_STRING && newRichString != null)) {
			...
			if (newRichString != null)
				msgs = ((InternalEObject)newRichString).eInverseAdd(this, LDocCompilerPackage.PROCESSED_RICH_STRING__LINES, ProcessedRichString.class, msgs);
			msgs = basicSetRichString(newRichString, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.LINE__RICH_STRING, newRichString, newRichString));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case LDocCompilerPackage.LINE__RICH_STRING:
				return eInternalContainer().eInverseRemove(this, LDocCompilerPackage.PROCESSED_RICH_STRING__LINES, ProcessedRichString.class, msgs);
		}
