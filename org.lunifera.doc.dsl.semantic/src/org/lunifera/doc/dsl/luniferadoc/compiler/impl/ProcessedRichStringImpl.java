 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ProcessedRichStringImpl#getRichString <em>Rich String</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ProcessedRichStringImpl#getLines <em>Lines</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessedRichStringImpl extends MinimalEObjectImpl.Container implements ProcessedRichString {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.PROCESSED_RICH_STRING;
	}
		...
		if (richString != null && richString.eIsProxy()) {
			...
			if (richString != oldRichString) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.PROCESSED_RICH_STRING__RICH_STRING, oldRichString, richString));
			}
		}
		return richString;
	}
	...
	public void setRichString(RichString newRichString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.PROCESSED_RICH_STRING__RICH_STRING, oldRichString, richString));
	}
	...
	public EList<Line> getLines() {
		if (lines == null) {
			lines = new EObjectContainmentWithInverseEList<Line>(Line.class, this, LDocCompilerPackage.PROCESSED_RICH_STRING__LINES, LDocCompilerPackage.LINE__RICH_STRING);
		}
		return lines;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocCompilerPackage.PROCESSED_RICH_STRING__LINES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.PROCESSED_RICH_STRING__RICH_STRING:
