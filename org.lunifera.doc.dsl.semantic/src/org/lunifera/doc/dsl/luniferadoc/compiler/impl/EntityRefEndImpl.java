 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.EntityRefEndImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntityRefEndImpl extends LinePartImpl implements EntityRefEnd {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.ENTITY_REF_END;
	}
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.ENTITY_REF_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public NotificationChain basicSetStart(EntityRefStart newStart, NotificationChain msgs) {
		...
		start = newStart;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.ENTITY_REF_END__START, oldStart, newStart);
	...
	public void setStart(EntityRefStart newStart) {
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject)start).eInverseRemove(this, LDocCompilerPackage.ENTITY_REF_START__END, EntityRefStart.class, msgs);
			if (newStart != null)
				msgs = ((InternalEObject)newStart).eInverseAdd(this, LDocCompilerPackage.ENTITY_REF_START__END, EntityRefStart.class, msgs);
			msgs = basicSetStart(newStart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.ENTITY_REF_END__START, newStart, newStart));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocCompilerPackage.ENTITY_REF_END__START:
				if (start != null)
					msgs = ((InternalEObject)start).eInverseRemove(this, LDocCompilerPackage.ENTITY_REF_START__END, EntityRefStart.class, msgs);
