 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ElseStartImpl#getIfConditionStart <em>If Condition Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElseStartImpl extends LinePartImpl implements ElseStart {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.ELSE_START;
	}
		...
		if (ifConditionStart != null && ifConditionStart.eIsProxy()) {
			...
			if (ifConditionStart != oldIfConditionStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.ELSE_START__IF_CONDITION_START, oldIfConditionStart, ifConditionStart));
			}
		}
	...
	public NotificationChain basicSetIfConditionStart(IfConditionStart newIfConditionStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.ELSE_START__IF_CONDITION_START, oldIfConditionStart, newIfConditionStart);
	...
	public void setIfConditionStart(IfConditionStart newIfConditionStart) {
		if (newIfConditionStart != ifConditionStart) {
			...
			if (ifConditionStart != null)
				msgs = ((InternalEObject)ifConditionStart).eInverseRemove(this, LDocCompilerPackage.IF_CONDITION_START__ELSE_START, IfConditionStart.class, msgs);
			if (newIfConditionStart != null)
				msgs = ((InternalEObject)newIfConditionStart).eInverseAdd(this, LDocCompilerPackage.IF_CONDITION_START__ELSE_START, IfConditionStart.class, msgs);
			msgs = basicSetIfConditionStart(newIfConditionStart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.ELSE_START__IF_CONDITION_START, newIfConditionStart, newIfConditionStart));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDocCompilerPackage.ELSE_START__IF_CONDITION_START:
				if (ifConditionStart != null)
					msgs = ((InternalEObject)ifConditionStart).eInverseRemove(this, LDocCompilerPackage.IF_CONDITION_START__ELSE_START, IfConditionStart.class, msgs);
