 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ListStartImpl#getContent <em>Content</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ListStartImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.compiler.impl.ListStartImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ListStartImpl extends LinePartImpl implements ListStart {
	...
	protected EClass eStaticClass() {
		return LDocCompilerPackage.Literals.LIST_START;
	}
		...
		if (content != null && content.eIsProxy()) {
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.LIST_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public void setContent(RichStringList newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.LIST_START__CONTENT, oldContent, content));
	}
	...
	public EList<ListElementStart> getElements() {
		if (elements == null) {
			elements = new EObjectResolvingEList<ListElementStart>(ListElementStart.class, this, LDocCompilerPackage.LIST_START__ELEMENTS);
		}
		return elements;
	}
	...
	public ListEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDocCompilerPackage.LIST_START__END, oldEnd, end));
			}
		}
		return end;
	}
	...
	public void setEnd(ListEnd newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDocCompilerPackage.LIST_START__END, oldEnd, end));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDocCompilerPackage.LIST_START__CONTENT:
				if (resolve) return getContent();
				return basicGetContent();
			case LDocCompilerPackage.LIST_START__ELEMENTS:
				return getElements();
			case LDocCompilerPackage.LIST_START__END:
