...
public enum DocType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final DocType[] VALUES_ARRAY = new DocType[] { ENTITY, DTO, BPM_PROCESS,
			BPM_TASK, VAACLIPSE_VIEW, UI, };
	 ...
	 * @generated
	 */
	public static final List<DocType> VALUES = Collections.unmodifiableList(Arrays
			.asList(VALUES_ARRAY));
