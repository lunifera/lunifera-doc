...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sub Section End</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.SubSectionEndImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SubSectionEndImpl extends LinePartImpl implements SubSectionEnd {
	...
	protected EClass eStaticClass() {
		return LunDocCompilerPackage.Literals.SUB_SECTION_END;
	}
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.SUB_SECTION_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public void setStart(SubSectionStart newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.SUB_SECTION_END__START, oldStart, start));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunDocCompilerPackage.SUB_SECTION_END__START:
