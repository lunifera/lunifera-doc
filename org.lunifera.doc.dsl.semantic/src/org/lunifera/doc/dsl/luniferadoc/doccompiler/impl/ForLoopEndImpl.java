 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.ForLoopEndImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForLoopEndImpl extends LinePartImpl implements ForLoopEnd {
	...
	protected EClass eStaticClass() {
		return LunDocCompilerPackage.Literals.FOR_LOOP_END;
	}
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.FOR_LOOP_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public NotificationChain basicSetStart(ForLoopStart newStart, NotificationChain msgs) {
		...
		start = newStart;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.FOR_LOOP_END__START, oldStart, newStart);
	...
	public void setStart(ForLoopStart newStart) {
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject)start).eInverseRemove(this, LunDocCompilerPackage.FOR_LOOP_START__END, ForLoopStart.class, msgs);
			if (newStart != null)
				msgs = ((InternalEObject)newStart).eInverseAdd(this, LunDocCompilerPackage.FOR_LOOP_START__END, ForLoopStart.class, msgs);
			msgs = basicSetStart(newStart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.FOR_LOOP_END__START, newStart, newStart));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LunDocCompilerPackage.FOR_LOOP_END__START:
				if (start != null)
					msgs = ((InternalEObject)start).eInverseRemove(this, LunDocCompilerPackage.FOR_LOOP_START__END, ForLoopStart.class, msgs);
