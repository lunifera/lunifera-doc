...
public class LDocBPMProcessDocumentImpl extends MinimalEObjectImpl.Container implements LDocBPMProcessDocument {
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__LANGUAGE, oldLanguage, language));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__NAME:
				return getName();
			case LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__LANGUAGE:
				return getLanguage();
			case LunDocPackage.LDOC_BPM_PROCESS_DOCUMENT__DESCRIPTION:
