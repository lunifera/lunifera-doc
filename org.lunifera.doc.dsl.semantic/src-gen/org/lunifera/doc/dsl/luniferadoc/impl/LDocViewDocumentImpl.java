...
public class LDocViewDocumentImpl extends MinimalEObjectImpl.Container implements LDocViewDocument
{
  ...
  public void setLanguage(String newLanguage)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocPackage.LDOC_VIEW_DOCUMENT__LANGUAGE, oldLanguage, language));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LunDocPackage.LDOC_VIEW_DOCUMENT__NAME:
        return getName();
      case LunDocPackage.LDOC_VIEW_DOCUMENT__LANGUAGE:
        return getLanguage();
      case LunDocPackage.LDOC_VIEW_DOCUMENT__DESCRIPTION:
