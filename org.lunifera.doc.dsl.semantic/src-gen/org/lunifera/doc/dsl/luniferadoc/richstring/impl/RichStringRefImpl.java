...
public class RichStringRefImpl extends RichStringMarkupImpl implements RichStringRef
{
  ...
  {
    return LunDocRichstringPackage.Literals.RICH_STRING_REF;
  }
  ...
  public void setRefId(String newRefId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocRichstringPackage.RICH_STRING_REF__REF_ID, oldRefId, refId));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LunDocRichstringPackage.RICH_STRING_REF__REF_ID:
        return getRefId();
    }
