 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.H6StartImpl#getContent <em>Content</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.H6StartImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class H6StartImpl extends LinePartImpl implements H6Start
{
  ...
  {
    return LunDocCompilerPackage.Literals.H6_START;
  }
    ...
    if (content != null && content.eIsProxy())
    {
      ...
      if (content != oldContent)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.H6_START__CONTENT, oldContent, content));
      }
    }
    return content;
  }
  ...
  public void setContent(RichStringH6 newContent)
  {
    ...
    content = newContent;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.H6_START__CONTENT, oldContent, content));
  }
  ...
  public H6End getEnd()
  {
    if (end != null && end.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.H6_START__END, oldEnd, end));
      }
    }
    return end;
  }
  ...
  public void setEnd(H6End newEnd)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.H6_START__END, oldEnd, end));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LunDocCompilerPackage.H6_START__CONTENT:
        if (resolve) return getContent();
        return basicGetContent();
      case LunDocCompilerPackage.H6_START__END:
