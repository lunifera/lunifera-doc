 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.URLEndImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class URLEndImpl extends LinePartImpl implements URLEnd
{
  ...
  {
    return LunDocCompilerPackage.Literals.URL_END;
  }
    ...
    if (start != null && start.eIsProxy())
    {
      ...
      if (start != oldStart)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.URL_END__START, oldStart, start));
      }
    }
    return start;
  }
  ...
  public void setStart(URLStart newStart)
  {
    ...
    start = newStart;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.URL_END__START, oldStart, start));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LunDocCompilerPackage.URL_END__START:
