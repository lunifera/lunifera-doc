 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.RefEndImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RefEndImpl extends LinePartImpl implements RefEnd {
	...
	protected EClass eStaticClass() {
		return LunDocCompilerPackage.Literals.REF_END;
	}
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.REF_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public void setStart(RefStart newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.REF_END__START, oldStart, start));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunDocCompilerPackage.REF_END__START:
