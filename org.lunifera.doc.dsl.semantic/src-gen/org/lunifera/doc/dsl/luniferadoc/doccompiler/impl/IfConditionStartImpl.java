 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.IfConditionStartImpl#getRichStringIf <em>Rich String If</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.IfConditionStartImpl#getElseStart <em>Else Start</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.IfConditionStartImpl#getElseIfConditions <em>Else If Conditions</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.IfConditionStartImpl#getEndIf <em>End If</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfConditionStartImpl extends LinePartImpl implements IfConditionStart {
	...
	protected EClass eStaticClass() {
		return LunDocCompilerPackage.Literals.IF_CONDITION_START;
	}
		...
		if (richStringIf != null && richStringIf.eIsProxy()) {
			...
			if (richStringIf != oldRichStringIf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.IF_CONDITION_START__RICH_STRING_IF, oldRichStringIf, richStringIf));
			}
		}
		return richStringIf;
	}
	...
	public void setRichStringIf(RichStringIf newRichStringIf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.IF_CONDITION_START__RICH_STRING_IF, oldRichStringIf, richStringIf));
	}
	...
	public ElseStart getElseStart() {
		if (elseStart != null && elseStart.eIsProxy()) {
			...
			if (elseStart != oldElseStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.IF_CONDITION_START__ELSE_START, oldElseStart, elseStart));
			}
		}
		return elseStart;
	}
	...
	public NotificationChain basicSetElseStart(ElseStart newElseStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.IF_CONDITION_START__ELSE_START, oldElseStart, newElseStart);
	...
	public void setElseStart(ElseStart newElseStart) {
		if (newElseStart != elseStart) {
			...
			if (elseStart != null)
				msgs = ((InternalEObject)elseStart).eInverseRemove(this, LunDocCompilerPackage.ELSE_START__IF_CONDITION_START, ElseStart.class, msgs);
			if (newElseStart != null)
				msgs = ((InternalEObject)newElseStart).eInverseAdd(this, LunDocCompilerPackage.ELSE_START__IF_CONDITION_START, ElseStart.class, msgs);
			msgs = basicSetElseStart(newElseStart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.IF_CONDITION_START__ELSE_START, newElseStart, newElseStart));
	}
	...
	public EList<ElseIfCondition> getElseIfConditions() {
		if (elseIfConditions == null) {
			elseIfConditions = new EObjectWithInverseResolvingEList<ElseIfCondition>(ElseIfCondition.class, this, LunDocCompilerPackage.IF_CONDITION_START__ELSE_IF_CONDITIONS, LunDocCompilerPackage.ELSE_IF_CONDITION__IF_CONDITION_START);
		}
	...
	public EndIf getEndIf() {
		if (endIf != null && endIf.eIsProxy()) {
			...
			if (endIf != oldEndIf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.IF_CONDITION_START__END_IF, oldEndIf, endIf));
			}
		}
		return endIf;
	}
	...
	public void setEndIf(EndIf newEndIf) {
		...
		endIf = newEndIf;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.IF_CONDITION_START__END_IF, oldEndIf, endIf));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LunDocCompilerPackage.IF_CONDITION_START__ELSE_START:
				if (elseStart != null)
					msgs = ((InternalEObject)elseStart).eInverseRemove(this, LunDocCompilerPackage.ELSE_START__IF_CONDITION_START, ElseStart.class, msgs);
				return basicSetElseStart((ElseStart)otherEnd, msgs);
			case LunDocCompilerPackage.IF_CONDITION_START__ELSE_IF_CONDITIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunDocCompilerPackage.IF_CONDITION_START__RICH_STRING_IF:
			...
			case LunDocCompilerPackage.IF_CONDITION_START__END_IF:
