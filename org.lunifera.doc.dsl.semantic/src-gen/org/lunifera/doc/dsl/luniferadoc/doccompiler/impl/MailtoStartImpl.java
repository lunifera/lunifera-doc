 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.MailtoStartImpl#getContent <em>Content</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.MailtoStartImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MailtoStartImpl extends LinePartImpl implements MailtoStart {
	...
	protected EClass eStaticClass() {
		return LunDocCompilerPackage.Literals.MAILTO_START;
	}
		...
		if (content != null && content.eIsProxy()) {
			...
			if (content != oldContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.MAILTO_START__CONTENT, oldContent, content));
			}
		}
		return content;
	}
	...
	public void setContent(RichStringMailto newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.MAILTO_START__CONTENT, oldContent, content));
	}
	...
	public MailtoEnd getEnd() {
		if (end != null && end.eIsProxy()) {
			...
			if (end != oldEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.MAILTO_START__END, oldEnd, end));
			}
		}
		return end;
	}
	...
	public void setEnd(MailtoEnd newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.MAILTO_START__END, oldEnd, end));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunDocCompilerPackage.MAILTO_START__CONTENT:
				if (resolve) return getContent();
				return basicGetContent();
			case LunDocCompilerPackage.MAILTO_START__END:
