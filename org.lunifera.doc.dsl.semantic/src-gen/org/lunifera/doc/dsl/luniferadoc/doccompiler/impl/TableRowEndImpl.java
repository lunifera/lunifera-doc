 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.TableRowEndImpl#getStart <em>Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableRowEndImpl extends LinePartImpl implements TableRowEnd {
	...
	protected EClass eStaticClass() {
		return LunDocCompilerPackage.Literals.TABLE_ROW_END;
	}
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.TABLE_ROW_END__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public void setStart(TableRowStart newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.TABLE_ROW_END__START, oldStart, start));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LunDocCompilerPackage.TABLE_ROW_END__START:
