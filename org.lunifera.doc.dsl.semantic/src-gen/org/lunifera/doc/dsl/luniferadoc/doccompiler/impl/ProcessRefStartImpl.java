 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.ProcessRefStartImpl#getContent <em>Content</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.ProcessRefStartImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessRefStartImpl extends LinePartImpl implements ProcessRefStart
{
  ...
  {
    return LunDocCompilerPackage.Literals.PROCESS_REF_START;
  }
    ...
    if (content != null && content.eIsProxy())
    {
      ...
      if (content != oldContent)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.PROCESS_REF_START__CONTENT, oldContent, content));
      }
    }
    return content;
  }
  ...
  public void setContent(RichStringProcessRef newContent)
  {
    ...
    content = newContent;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.PROCESS_REF_START__CONTENT, oldContent, content));
  }
  ...
  public ProcessRefEnd getEnd()
  {
    if (end != null && end.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.PROCESS_REF_START__END, oldEnd, end));
      }
    }
    return end;
  }
  ...
  public void setEnd(ProcessRefEnd newEnd)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.PROCESS_REF_START__END, oldEnd, end));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LunDocCompilerPackage.PROCESS_REF_START__CONTENT:
        if (resolve) return getContent();
        return basicGetContent();
      case LunDocCompilerPackage.PROCESS_REF_START__END:
