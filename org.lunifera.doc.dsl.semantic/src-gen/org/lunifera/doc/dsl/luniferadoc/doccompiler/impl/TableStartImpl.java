 ...
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.TableStartImpl#getContent <em>Content</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.TableStartImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableStartImpl extends LinePartImpl implements TableStart
{
  ...
  {
    return LunDocCompilerPackage.Literals.TABLE_START;
  }
    ...
    if (content != null && content.eIsProxy())
    {
      ...
      if (content != oldContent)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.TABLE_START__CONTENT, oldContent, content));
      }
    }
    return content;
  }
  ...
  public void setContent(RichStringTable newContent)
  {
    ...
    content = newContent;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.TABLE_START__CONTENT, oldContent, content));
  }
  ...
  public TableEnd getEnd()
  {
    if (end != null && end.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.TABLE_START__END, oldEnd, end));
      }
    }
    return end;
  }
  ...
  public void setEnd(TableEnd newEnd)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.TABLE_START__END, oldEnd, end));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LunDocCompilerPackage.TABLE_START__CONTENT:
        if (resolve) return getContent();
        return basicGetContent();
      case LunDocCompilerPackage.TABLE_START__END:
