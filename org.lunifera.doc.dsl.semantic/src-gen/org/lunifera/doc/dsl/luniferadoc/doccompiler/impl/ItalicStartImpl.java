...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Italic Start</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.ItalicStartImpl#getContent <em>Content</em>}</li>
 *   <li>{@link org.lunifera.doc.dsl.luniferadoc.doccompiler.impl.ItalicStartImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ItalicStartImpl extends LinePartImpl implements ItalicStart
{
  ...
  {
    return LunDocCompilerPackage.Literals.ITALIC_START;
  }
    ...
    if (content != null && content.eIsProxy())
    {
      ...
      if (content != oldContent)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.ITALIC_START__CONTENT, oldContent, content));
      }
    }
    return content;
  }
  ...
  public void setContent(RichStringItalic newContent)
  {
    ...
    content = newContent;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.ITALIC_START__CONTENT, oldContent, content));
  }
  ...
  public ItalicEnd getEnd()
  {
    if (end != null && end.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, LunDocCompilerPackage.ITALIC_START__END, oldEnd, end));
      }
    }
    return end;
  }
  ...
  public void setEnd(ItalicEnd newEnd)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LunDocCompilerPackage.ITALIC_START__END, oldEnd, end));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LunDocCompilerPackage.ITALIC_START__CONTENT:
        if (resolve) return getContent();
        return basicGetContent();
      case LunDocCompilerPackage.ITALIC_START__END:
