...
/**
 * Manual modifications go to {org.lunifera.doc.dsl.LuniferaDocGrammarRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractLuniferaDocGrammarRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/lunifera/doc/dsl/LuniferaDocGrammar.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.lunifera.doc.dsl.LuniferaDocGrammar");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("docu");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.lunifera.doc.dsl.services.LuniferaDocGrammarGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.lunifera.doc.dsl.serializer.LuniferaDocGrammarSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.lunifera.doc.dsl.serializer.LuniferaDocGrammarSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.lunifera.doc.dsl.parser.antlr.LuniferaDocGrammarParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.lunifera.doc.dsl.parser.antlr.LuniferaDocGrammarAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.lunifera.doc.dsl.parser.antlr.internal.InternalLuniferaDocGrammarLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.lunifera.doc.dsl.parser.antlr.internal.InternalLuniferaDocGrammarLexer> provideInternalLuniferaDocGrammarLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.lunifera.doc.dsl.parser.antlr.internal.InternalLuniferaDocGrammarLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.lunifera.doc.dsl.parser.antlr.internal.InternalLuniferaDocGrammarLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.lunifera.doc.dsl.validation.LuniferaDocGrammarValidator> bindLuniferaDocGrammarValidator() {
		return org.lunifera.doc.dsl.validation.LuniferaDocGrammarValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.lunifera.doc.dsl.jvmmodel.LuniferaDocGrammarJvmModelInferrer.class;
	}
